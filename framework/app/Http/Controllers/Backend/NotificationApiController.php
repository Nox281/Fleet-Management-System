    ...
    public function vehicle_registration()
    {
        ...
        foreach ($notifications as $row) {
            ...
            $details[] = array(
                ...
                'vehicle' => $vehicle->maker->make . " - " . $vehicle->vehiclemodel->model,
                'notification' => __('fleet.reg_certificate') . date(ayoubgr::get('date_format'), strtotime($row->data['msg'])),
    ...
    public function vehicle_insurance()
    {
        ...
        foreach ($notifications as $row) {
            ...
            $details[] = array(
                'image' => ($vehicle->vehicle_image != null) ? asset('uploads/' . $vehicle->vehicle_image) : asset("assets/images/vehicle.jpeg"),
                'vehicle' => $vehicle->maker->make . " - " . $vehicle->vehiclemodel->model,
                'notification' => __('fleet.vehicle_insurance') . date(ayoubgr::get('date_format'), strtotime($row->data['msg'])),
                'remaining_days' => $remaining_days,
            );
        }
        $data['success'] = "1";
    ...
    public function vehicle_license()
    {
        ...
        foreach ($notifications as $row) {
            ...
            $details[] = array(
                'image' => ($vehicle->vehicle_image != null) ? asset('uploads/' . $vehicle->vehicle_image) : asset("assets/images/vehicle.jpeg"),
                'vehicle' => $vehicle->maker->make . " - " . $vehicle->vehiclemodel->model,
                'notification' => __('fleet.vehicle_licence') . date(ayoubgr::get('date_format'), strtotime($row->data['msg'])),
                'remaining_days' => $remaining_days,
            );
        }
        $data['success'] = "1";
    ...
    public function driver_license()
    {
        ...
        foreach ($notifications as $row) {
            ...
            $details[] = array(
                ...
                'notification' => __('fleet.driver_licence') . date(ayoubgr::get('date_format'), strtotime($row->data['msg'])),
                'remaining_days' => $remaining_days,
            );
        }
        $data['success'] = "1";
    ...
    public function service_reminder()
    {
        ...
        foreach ($notifications as $row) {
            ...
            $details[] = array(
                ...
                'vehicle' => $reminder->vehicle->year . " " . $reminder->vehicle->maker->make . " " . $reminder->vehicle->vehiclemodel->model,
