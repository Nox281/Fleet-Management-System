...
class EmailSettingsApiController extends Controller
{
    ...
    public function get_email_content()
    {
        ...
        $data['data'] = array(
            'insurance' => ayoubgr::email_msg('insurance'),
            'vehicle_licence' => ayoubgr::email_msg('vehicle_licence'),
            'driving_licence' => ayoubgr::email_msg('driving_licence'),
            'registration' => ayoubgr::email_msg('registration'),
            'service_reminder' => ayoubgr::email_msg('service_reminder'),
        );
        return $data;
    }
    ...
    public function get_email_settings()
    {
        ...
        $data['data'] = array(
            ...
            'email' => (ayoubgr::email_msg('email') == 1) ? "Enabled" : "Disabled",
            'email_value' => ayoubgr::email_msg('email'),
        );
        return $data;
    }
}
