    ...
    public function get_api_settings()
    {
        ...
        $data['data'] = array(
            'general_settings' => array(
                'api' => (ayoubgr::api('api') == 1) ? 1 : 0,
                'google_api' => (ayoubgr::api('google_api') == 1) ? 1 : 0,
                'anyone_register' => (ayoubgr::api('anyone_register') == 1) ? 1 : 0,
                'driver_review' => (ayoubgr::api('driver_review') == 1) ? 1 : 0,
                'region_availability' => ayoubgr::api('region_availability'),
                'booking_days' => ayoubgr::api('booking'),
                'cancel_days' => ayoubgr::api('cancel'),
                'max_trip_days' => ayoubgr::api('max_trip'),
            ),
            'firebase_settings' => array(
                'db_url' => ayoubgr::api('db_url'),
                'db_secret' => ayoubgr::api('db_secret'),
            ),
            'app_notification' => array(
                'server_key' => ayoubgr::api('server_key'),
            ),
            'driver_maps' => array(
                'api_key' => ayoubgr::api('api_key'),
            ),
        );
