...
class VehiclesApiController extends Controller
{
    ...
    public function driver_logs()
    {
        ...
        foreach ($logs as $log) {
            $details[] = array(
                'id' => $log->id,
                'vehicle' => $log->vehicle->maker->make . " - " . $log->vehicle->vehiclemodel->model . " - " . $log->vehicle->license_plate,
        ...
        foreach ($vehicles as $row) {
            ...
            if ($info != null) {
                ...
                foreach ($info as $key => $val) {
                    ...
                    $purchase_info[] = array(
                        ...
                        'amount' => ayoubgr::get('currency') . " " . $val['exp_amount'],
                    );
                }
            ...
            $details[] = array(
                ...
                "vehicle_info" => array(
                    ...
                    "Initial mileage (" . ayoubgr::get('dis_format') . ")" => $row->int_mileage,
