...
class SettingsApiController extends Controller
{
    ...
    public function get_front_settings()
    {
        ...
        $details = array(
            'is_enable' => (ayoubgr::frontend('enable') == 1) ? 1 : 0,
            'is_enable_value' => (ayoubgr::frontend('enable') == 1) ? "Enable" : "Disable",
            'about_us' => ayoubgr::frontend('about_us'),
            'customer_support' => ayoubgr::frontend('customer_support'),
            'contact_number' => ayoubgr::frontend('contact_phone'),
            'contact_email' => ayoubgr::frontend('contact_email'),
            'about_description' => ayoubgr::frontend('about_description'),
            'about_title' => ayoubgr::frontend('about_title'),
            'language' => ayoubgr::frontend('language'),
            'faq_link' => ayoubgr::frontend('faq_link'),
            'cities' => ayoubgr::frontend('cities'),
            'vehicles' => ayoubgr::frontend('vehicles'),
            'cancellation_link' => ayoubgr::frontend('cancellation'),
            'terms' => ayoubgr::frontend('terms'),
            'privacy_policy' => ayoubgr::frontend('privacy_policy'),
            'facebook' => ayoubgr::frontend('facebook'),
            'twitter' => ayoubgr::frontend('twitter'),
            'instagram' => ayoubgr::frontend('instagram'),
            'linkedin' => ayoubgr::frontend('linkedin'),
        );
        $data['success'] = "1";
    ...
    public function get_general_settings()
    {
        ...
        $details = array(
            'app_name' => ayoubgr::get('app_name'),
            'email' => ayoubgr::get('email'),
            'address1' => ayoubgr::get('badd1'),
            'address2' => ayoubgr::get('badd2'),
            'city' => ayoubgr::get('city'),
            'state' => ayoubgr::get('state'),
            'country' => ayoubgr::get('country'),
            'distance_format' => ayoubgr::get("dis_format"),
            'fuel_unit' => ayoubgr::get("fuel_unit"),
            'time_interval' => ayoubgr::get('time_interval'),
            'icon_image' => asset('assets/images/' . ayoubgr::get('icon_img')),
            'logo_image' => asset('assets/images/' . ayoubgr::get('logo_img')),
            'currency' => ayoubgr::get('currency'),
            'date_format' => $date_setting,
            'tax_no' => ayoubgr::get('tax_no'),
            'invoice_text' => ayoubgr::get('invoice_text'),
