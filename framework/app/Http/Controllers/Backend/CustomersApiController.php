...
class CustomersApiController extends Controller
{
    ...
    public function home()
    {
        ...
        $details = array(
            ...
            'total_amount' => ayoubgr::get('currency') . " " . ((is_null($income[0]->income) ? 0 : $income[0]->income)),
            'total_distance' => ((is_null($total_kms[0]->total_kms) ? 0 : $total_kms[0]->total_kms)) . " " . ayoubgr::get('dis_format'),
