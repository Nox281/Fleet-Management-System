<div class="btn-group">
    ...
    <div class="dropdown-menu custom" role="menu">
      ...
      <a data-toggle="modal" data-target="#receiptModal" class="open-AddBookDialog dropdown-item" data-booking-id="<?php echo e($row->id); ?>" data-user-id="<?php echo e($row->user_id); ?>" data-customer-id="<?php echo e($row->customer_id); ?>" data-vehicle-id= "<?php echo e($row->vehicle_id); ?>" data-vehicle-type="<?php echo e(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype))); ?>" data-base-mileage="<?php echo e(($row->total_kms)?$row->total_kms:ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_base_km')); ?>" data-base-fare="<?php echo e(($row->total)?$row->total:ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_base_fare')); ?>"
      data-base_km_1="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_base_km')); ?>"
      data-base_fare_1="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_base_fare')); ?>"
      data-wait_time_1="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_base_time')); ?>"
      data-std_fare_1="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_std_fare')); ?>"

      data-base_km_2="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_weekend_base_km')); ?>"
      data-base_fare_2="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_weekend_base_fare')); ?>"
      data-wait_time_2="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_weekend_wait_time')); ?>"
      data-std_fare_2="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_weekend_std_fare')); ?>"

      data-base_km_3="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_night_base_km')); ?>"
      data-base_fare_3="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_night_base_fare')); ?>"
      data-wait_time_3="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_night_wait_time')); ?>"
      data-std_fare_3="<?php echo e(ayoubgr::fare(strtolower(str_replace(' ','',$row->vehicle->types->vehicletype)).'_night_std_fare')); ?>"
...
<?php echo Form::close(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/bookings/list-actions.blade.php ENDPATH**/ ?>