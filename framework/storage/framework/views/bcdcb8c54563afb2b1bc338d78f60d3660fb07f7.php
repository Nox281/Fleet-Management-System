    ...
    <div class="modal-content">
      <div class="card card-info">
        ...
        <div class="fleet card-body">
          ...
          <?php ($no_of_tax = sizeof(json_decode(ayoubgr::get('tax_charge'), true))); ?>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php echo app('translator')->get('fleet.trip_mileage'); ?> (<?php echo e(ayoubgr::get('dis_format')); ?>)</label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/bookings/index.blade.php ENDPATH**/ ?>