        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6">
            <select id="vehicle_id" name="vehicle_id" class="form-control vehicles" style="width: 100%" required>
              ...
              <option value="<?php echo e($vehicle->id); ?>"><?php echo e($vehicle->maker->make); ?>-<?php echo e($vehicle->vehiclemodel->model); ?>-<?php echo e($vehicle->license_plate); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
          <div class="col-md-4" style="margin-top: 5px;">
            <select id="expense_type" name="expense_type" class="form-control vehicles" required  style="width: 100%">
              <option value="" ><?php echo app('translator')->get('fleet.expenseType'); ?></option>
              <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="e_<?php echo e($type->id); ?>"><?php echo e($type->name); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <optgroup label="<?php echo app('translator')->get('fleet.serviceItems'); ?>">
          ...
          <div class="col-md-4" style="margin-top: 5px">
            <select id="vendor_id" name="vendor_id" class="form-control vendor" style="width: 100%">
              <option value=""><?php echo app('translator')->get('fleet.select_vendor'); ?></option>
          ...
          <div class="col-md-4" style="margin-top: 10px;">
            <div class="input-group">
              <input  name="comment" type="text" id="comment" class="form-control" placeholder=" <?php echo app('translator')->get('fleet.note'); ?>" style="width: 250px">
            </div>
          </div>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <div class="row">
          <div class="col-md-4">
            <h3 class="card-title"> <?php echo app('translator')->get('fleet.todayExpense'); ?> : <strong><span id="total_today"><?php echo e($currency.' '. $total); ?> </span> </strong> </h3>
          </div>
        ...
        <table class="table" id="data_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Transactions delete')): ?><button type="button" class="btn btn-danger delete" id="btn_delete" data-id="<?php echo e($row->id); ?>" title="<?php echo app('translator')->get('fleet.delete'); ?>">
...
$(document).ready(function() {
  ...
  $('#expense_type').select2({placeholder: "<?php echo app('translator')->get('fleet.expenseType'); ?>"});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/expense/index.blade.php ENDPATH**/ ?>