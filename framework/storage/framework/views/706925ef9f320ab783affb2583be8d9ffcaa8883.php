...
<?php else: ?>
<?php ($language = ayoubgr::get("language")); ?>
<?php endif; ?>
...
<body class="hold-transition <?php echo e(auth()->user()->theme); ?> layout-fixed sidebar-mini" <?php if($language=="Arabic-ar" ): ?> dir="rtl"
  <?php endif; ?>>
  ...
  <div class="wrapper">
    ...
    <nav
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="https://fleetdocs.ayoubgr.space" class="nav-link">Help</a>
        </li>
      </ul>
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div>
              <div style="margin: 5px;">
                <a href="<?php echo e(url('admin/change-details/'.Auth::user()->id)); ?>" class="btn btn-secondary btn-flat"><i
                    class="fa fa-edit"></i> <?php echo app('translator')->get('fleet.editProfile'); ?></a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?php echo e(url('admin/')); ?>" class="brand-link">
        <img src="<?php echo e(asset('assets/images/'. ayoubgr::get('icon_img') )); ?>" alt="Fleet Logo" class="brand-image"
          style="opacity: .8">
        <span class="brand-text font-weight-light"><?php echo e(ayoubgr::get('app_name')); ?></span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            ...
            <?php else: ?>
            <img src="<?php echo e(asset('uploads/'.Auth::user()->getMeta('profile_image'))); ?>" class="img-circle elevation-2"
              alt="User Image">
            <?php endif; ?>
            <?php elseif(Auth::user()->user_type == 'C' && Auth::user()->getMeta('profile_pic') != null): ?>
            <?php if(starts_with(Auth::user()->getMeta('profile_pic'),'http')): ?>
         ...
         with font-awesome or any other icon font library -->
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('admin/vehicle-inspection')); ?>"
                  class="nav-link <?php if((Request::is('admin/vehicle-inspection*')) || (Request::is('admin/view-vehicle-inspection*')) || (Request::is('admin/print-vehicle-inspection*'))): ?> active <?php endif; ?>">
              ...
              <?php if(!empty(ayoubgr::chat('pusher_app_id')) && !empty(ayoubgr::chat ('pusher_app_key')) &&
              !empty(ayoubgr::chat('pusher_app_secret')) && !empty(ayoubgr::chat('pusher_app_cluster'))): ?>

              <li class="nav-item">
                <a href="<?php echo e(url('admin/chat/')); ?>" class="nav-link <?php if(Request::is('admin/chat')): ?> active <?php endif; ?>">
              ...
              <?php if(ayoubgr::get('fuel_enable_driver') == 1): ?>
              ...
              <?php if(ayoubgr::get('income_enable_driver') == 1 || ayoubgr::get('expense_enable_driver') == 1): ?>
              <?php if((Request::is('admin/income')) || (Request::is('admin/expense')) || (Request::is('admin/transaction'))
              ...
              <li class="nav-item has-treeview <?php echo e($class); ?>">
                ...
                <ul class="nav nav-treeview">
                  <?php if(ayoubgr::get('income_enable_driver') == 1): ?>
                  <li class="nav-item">
                  ...
                  <?php endif; ?>
                  <?php if(ayoubgr::get('expense_enable_driver') == 1): ?>
                  <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('customers.index')); ?>"
                      ...
                      <p><?php echo app('translator')->get('fleet.customers'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                  <?php if(!empty(ayoubgr::chat('pusher_app_id')) && !empty(ayoubgr::chat ('pusher_app_key')) &&
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('chat.index')); ?>" class="nav-link <?php if(Request::is('admin/chat')): ?> active <?php endif; ?>">
              ...
              <?php if((Request::is('admin/driver-logs')) || (Request::is('admin/vehicle-types*')) ||
              ...
              <?php ($active=""); ?>
              <?php endif; ?>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['Vehicles list','VehicleType list','VehicleGroup list','VehicleInspection list','VehicleColors
              ...
              <li class="nav-item has-treeview <?php echo e($class); ?>">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('VehicleMaker list')): ?>
                  <li class="nav-item">
                    <a href="<?php echo e(route('vehicle-make.index')); ?>"
                      class="nav-link <?php if(Request::is('admin/vehicle-make*')): ?> active <?php endif; ?>">
                      <i class="fa fa-car nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.make'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('VehicleModels list')): ?>
                  <li class="nav-item">
                    <a href="<?php echo e(route('vehicle-model.index')); ?>"
                      class="nav-link <?php if(Request::is('admin/vehicle-model*')): ?> active <?php endif; ?>">
                      <i class="fa fa-car nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.vehicle_models'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('VehicleColors list')): ?>
                  <li class="nav-item">
                    <a href="<?php echo e(route('vehicle-color.index')); ?>"
                      class="nav-link <?php if(Request::is('admin/vehicle-color*')): ?> active <?php endif; ?>">
                      <i class="fa fa-car nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.vehicle_colors'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Vehicles list')): ?>
                  <li class="nav-item">
                    <a href="<?php echo e(url('admin/driver-logs')); ?>"
                      class="nav-link <?php if(Request::is('admin/driver-logs*')): ?> active <?php endif; ?>">
                      <i class="fa fa-history nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.driver_logs'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('VehicleGroup list')): ?>
                  <li class="nav-item">
                    <a href="<?php echo e(route('vehicle_group.index')); ?>"
                      class="nav-link <?php if(Request::is('admin/vehicle_group*')): ?> active <?php endif; ?>">
                      <i class="fa fa-inbox nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.manageGroup'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(url('admin/vehicle-reviews')); ?>"
                      class="nav-link <?php if((Request::is('admin/vehicle-reviews*')) || (Request::is('admin/view-vehicle-review*')) || (Request::is('admin/vehicle-review*'))): ?> active <?php endif; ?>">
                      <i class="fa fa-briefcase nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.vehicle_inspection'); ?></p>
                    </a>
                  </li>
              ...
              <?php if((Request::is('admin/transactions*')) || (Request::is('admin/bookings*')) ||
              (Request::is('admin/bookings_calendar')) || (Request::is('admin/booking-quotation*'))): ?>
              <?php ($class="menu-open"); ?>
              <?php ($active="active"); ?>
              ...
              <li class="nav-item has-treeview <?php echo e($class); ?>">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(url('admin/reports/income')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/income')): ?> active <?php endif; ?>">
                      <i class="fa fa-credit-card nav-icon"></i>
                      <p> <?php echo app('translator')->get('fleet.income'); ?> <?php echo app('translator')->get('fleet.report'); ?></p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo e(url('admin/reports/expense')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/expense')): ?> active <?php endif; ?>">
                      <i class="fa fa-money-bill-alt nav-icon"></i>
                      <p> <?php echo app('translator')->get('fleet.expense'); ?> <?php echo app('translator')->get('fleet.report'); ?></p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.delinquent')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/delinquent')): ?> active <?php endif; ?>">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.monthly')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/monthly')): ?> active <?php endif; ?>">
                      <i class="fa fa-calendar nav-icon"></i>
                      <p><?php echo app('translator')->get('menu.monthlyReport'); ?></p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.booking')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/booking')): ?> active <?php endif; ?>">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.users')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/users')): ?> active <?php endif; ?>">
                      <i class="fa fa-address-book nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.work_order')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/work-order')): ?> active <?php endif; ?>">
                      <i class="nav-icon fa fa-book"></i>
                      <p><?php echo app('translator')->get('fleet.work_order_report'); ?></p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.fuel')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/fuel')): ?> active <?php endif; ?>">
                      <i class="fa fa-truck nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.fuelReport'); ?></p>
                    </a>
                  </li>


                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.drivers')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/drivers')): ?> active <?php endif; ?>">
                      <i class="fa fa-id-card nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.customers')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/customers')): ?> active <?php endif; ?>">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.vendors')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/vendors')): ?> active <?php endif; ?>">
                      <i class="fa fa-cubes nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.vendorReport'); ?></p>
                    </a>
                  </li>

                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.yearly')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/yearly')): ?> active <?php endif; ?>">
                      <i class="fa fa-calendar nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.yearlyReport'); ?></p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo e(route('reports.payments')); ?>"
                      class="nav-link <?php if(Request::is('admin/reports/payments')): ?> active <?php endif; ?>">
                      <i class="fa fa-money-check-alt nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.paymentReport'); ?></p>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-item has-treeview <?php echo e($class); ?>">
                <a href="#" class="nav-link <?php echo e($active); ?>">
                  ...
                  <p>
                    <?php echo app('translator')->get('fleet.parts'); ?>
                    <i class="right fa fa-angle-left"></i>
                  </p>
                </a>
                <ul class="nav nav-treeview">
                  ...
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('PartsCategory list')): ?>
                  <li class="nav-item">
                    <a href="<?php echo e(route('parts-category.index')); ?>"
                      class="nav-link <?php if(Request::is('admin/parts-category*')): ?> active <?php endif; ?>">
                      <i class="fa fa-list nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.partsCategory'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                </ul>
              ...
              <?php ($active=""); ?>
              <?php endif; ?>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['WorkOrders list','WorkOrders add','Mechanics list'])): ?>
              <li class="nav-item has-treeview <?php echo e($class); ?>">
                <a href="#" class="nav-link <?php echo e($active); ?>">
                  <i class="nav-icon fa fa-shopping-cart"></i>
                  <p>
                    <?php echo app('translator')->get('fleet.work_orders'); ?>
                    <i class="right fa fa-angle-left"></i>
                  </p>
                </a>
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('work_order.create')); ?>"
                      ...
                      <i class="fa fa-plus-square nav-icon"></i>
                      <p> <?php echo app('translator')->get('fleet.add_order'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('WorkOrders list')): ?>
                  <li class="nav-item">
                    <a href="<?php echo e(route('work_order.index')); ?>"
                      class="nav-link <?php if((Request::is('admin/work_order*')) && !(Request::is('admin/work_order/create')) && !(Request::is('admin/work_order/logs')) || Request::is('admin/parts-used*')): ?> active <?php endif; ?>">
                      <i class="fa fa-inbox nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.manage_work_order'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('WorkOrders list')): ?>
                  <li class="nav-item">
                    <a href="<?php echo e(url('admin/work_order/logs')); ?>"
                      ...
                      <i class="fa fa-history nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.work_order_logs'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Mechanics list')): ?>
                  <li class="nav-item">
                    <a href="<?php echo e(url('admin/mechanic')); ?>"
                      class="nav-link <?php if(Request::is('admin/mechanic*')): ?> active <?php endif; ?>">
                      <i class="fa fa-user nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.mechanics'); ?></p>
                    </a>
                  </li>
                  <?php endif; ?>
                </ul>
              ...
              <?php if(Request::is('admin/settings*') || Request::is('admin/roles*') || Request::is('admin/fare-settings') ||
              ...
              (Request::is('admin/twilio-settings*')) || (Request::is('admin/chat-settings*'))): ?>
              <?php ($class="menu-open"); ?>
              <?php ($active="active"); ?>
              ...
              <li class="nav-item has-treeview <?php echo e($class); ?>">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo e(route('roles.index')); ?>" class="nav-link <?php if(Request::is('admin/roles*')): ?> active <?php endif; ?>">
                      <i class="fa fa-tasks nav-icon"></i>
                      <p><?php echo app('translator')->get('fleet.user_access_management'); ?></p>
                    </a>
                  </li>
              ...
              <?php if(ayoubgr::api('api_key') != null && ayoubgr::api('db_url') != null): ?> <li class="nav-item">
              ...
              <?php if(ayoubgr::api('api') && ayoubgr::api('driver_review') == 1): ?> <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('admin/messages')); ?>" class="nav-link <?php if(Request::is('admin/messages')): ?> active <?php endif; ?>">
    ...
    <footer class="main-footer">
      <?php echo ayoubgr::get('web_footer'); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/layouts/app.blade.php ENDPATH**/ ?>