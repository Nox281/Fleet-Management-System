...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.vehicle_inspection'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
        <?php echo app('translator')->get('fleet.vehicle_inspection'); ?>
        &nbsp;
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('VehicleInspection add')): ?><a href="<?php echo e(url('admin/vehicle-reviews-create')); ?>" class="btn btn-success" title="<?php echo app('translator')->get('fleet.add_vehicle_inspection'); ?>"><i class="fa fa-plus"></i></a><?php endif; ?></h3>
      </div>
        ...
        <table class="table" id="ajax_data_table" style="padding-bottom: 25px">
          ...
          <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><?php echo e($r->vehicle->maker->make); ?> - <?php echo e($r->vehicle->vehiclemodel->model); ?> - <?php echo e($r->vehicle->types['displayname']); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/vehicles/vehicle_review_index.blade.php ENDPATH**/ ?>