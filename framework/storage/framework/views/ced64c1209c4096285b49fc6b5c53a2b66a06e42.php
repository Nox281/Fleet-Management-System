...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="col-sm-12">
                        <div class="hero-content--about w-100">
                            <div class="inner-content">
                                <h1 class="mb-0"><?php echo app('translator')->get('frontend.about'); ?> <?php echo e(ayoubgr::get('app_name')); ?></h1>
        ...
        <section class="about-fleet">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="text-center"><?php echo e(ayoubgr::frontend('about_title')); ?></h2>
                        <p> <?php echo e(ayoubgr::frontend('about_description')); ?></p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row mb-5">
                    ...
                    <div class="col-lg-8 col-md-6 d-flex flex-column justify-content-center pl-5 about-feature">
                        <h3 class="primary karla font-weight-bold mb-0"> <?php echo e(ayoubgr::frontend('cities')); ?>+</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-6 d-flex flex-column justify-content-center pl-5 about-feature">
                        <h3 class="primary karla font-weight-bold mb-0"><?php echo e(ayoubgr::frontend('vehicles')); ?>+</h3>
        ...
        <section class="my-5 py-5">
            <div class="container">
                <h2 class="mb-0 text-center mb-5 pb-3"><?php echo app('translator')->get('frontend.minds_behind'); ?> <?php echo e(ayoubgr::get('app_name')); ?></h2>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/frontend/about.blade.php ENDPATH**/ ?>