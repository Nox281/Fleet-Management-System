...
<div class="row">
  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text"><?php echo app('translator')->get('fleet.customers'); ?></span>
  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-10">
            <p class="text-center"><strong>Transactions: <?php if(count($dk) > 0): ?><?php echo e($dk[0]); ?> - <?php echo e(end($dk)); ?> <?php endif; ?>
              </strong></p>
            <div class="chart">
          ...
          <div class="col-md-2">
            ...
            <div class="info-box mb-3 bg-warning">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><?php echo app('translator')->get('fleet.bookings'); ?></span>
            ...
            <div class="info-box mb-3 bg-success">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo e(ayoubgr::get("currency")); ?><?php echo e($income); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <div class="info-box mb-3 bg-danger">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo e(ayoubgr::get("currency")); ?><?php echo e($expense); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/home.blade.php ENDPATH**/ ?>