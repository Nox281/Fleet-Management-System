...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.expense'); ?> <?php echo app('translator')->get('fleet.report'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.expense'); ?> <?php echo app('translator')->get('fleet.report'); ?>
        </h3>
      </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <button type="submit" formaction="<?php echo e(url('admin/print-expense')); ?>" class="btn btn-danger" style="margin-right: 10px"><i class="fa fa-print"></i> <?php echo app('translator')->get('fleet.print'); ?></button>
        </div>
        <?php echo Form::close(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/reports/expense.blade.php ENDPATH**/ ?>