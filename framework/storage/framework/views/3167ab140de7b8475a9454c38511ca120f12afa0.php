...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.change_details'); ?></li>
	...
	<div class="col-md-12">
		<div class="card card-warning">
			<div class="card-header">
				<h3 class="card-title"><?php echo app('translator')->get('fleet.change_details'); ?> : <strong><?php echo e($user_data->name); ?></strong></h3>
			</div>
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
						  <?php echo Form::label('dark_mode',__('fleet.dark_mode'), ['class' => 'form-label']); ?>

						  
						  <br>
						  <label class="switch">
							<input type="checkbox" name="theme" value="dark-mode" id="expense_enable_driver" <?php if($user_data->theme=='dark-mode'): ?> checked <?php endif; ?>>
					...
					<div class="row">
						<div class="form-group">
							<input type="submit"  class="form-control btn btn-warning"  value="<?php echo app('translator')->get('fleet.change_details'); ?>" />
						</div>
					</div>
				<?php echo Form::close(); ?>
...
<div class="row">
	<div class="col-md-12">
		<div class="card card-warning">
			<div class="card-header">
				<h3 class="card-title"><?php echo app('translator')->get('fleet.change_password'); ?> : <strong><?php echo e(Auth::user()->name); ?></strong> </h3>
			</div>
			<div class="card-body">
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							<input type="submit"  class="form-control btn btn-warning"  value="<?php echo app('translator')->get('fleet.change_password'); ?>" />
						</div>
						<?php echo Form::close(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/utilities/changepass.blade.php ENDPATH**/ ?>