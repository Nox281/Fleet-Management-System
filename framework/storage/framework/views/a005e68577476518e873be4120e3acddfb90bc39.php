...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.income'); ?> <?php echo app('translator')->get('fleet.report'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.income'); ?> <?php echo app('translator')->get('fleet.report'); ?>
        </h3>
      </div>

      <div class="card-body">
        <?php echo Form::open(['url' => 'admin/reports/income','method'=>'post','class'=>'form-inline']); ?>
        ...
        <div class="row">
          ...
          <div class="form-group" style="margin-right: 10px">
            ...
            <select id="vehicle_id" name="vehicle_id" class="form-control vehicles" style="width: 250px">
              ...
              <option value="<?php echo e($vehicle->id); ?>" <?php if($vehicle->id==$vehicle_id): ?> selected <?php endif; ?>><?php echo e($vehicle->maker->make); ?>-<?php echo e($vehicle->vehiclemodel->model); ?>-<?php echo e($vehicle->license_plate); ?></option>
          ...
          <button type="submit" formaction="<?php echo e(url('admin/print-income')); ?>" class="btn btn-danger" style="margin-right: 10px"><i class="fa fa-print"></i> <?php echo app('translator')->get('fleet.print'); ?></button>
        </div>
        <?php echo Form::close(); ?>
    ...
    <div class="card card-info">
      ...
      <div class="card-body table-responsive">
        <table class="table table-bordered table-striped table-hover"  id="myTable">
          ...
          <tbody>
            <?php $__currentLoopData = $income; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/reports/income.blade.php ENDPATH**/ ?>