...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.yearlyReport'); ?></li>
...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        <?php echo Form::open(['route' => 'reports.yearly','method'=>'post','class'=>'form-inline']); ?>
        ...
        <div class="row">
          ...
          <div class="form-group" style="margin-right: 10px">
            ...
            <select id="vehicle_id" name="vehicle_id" class="form-control vehicles" style="width: 250px">
              ...
              <?php endif; ?>><?php echo e($vehicle->maker->make); ?>-<?php echo e($vehicle->vehiclemodel->model); ?>-<?php echo e($vehicle->license_plate); ?></option>
          ...
          <button type="submit" formaction="<?php echo e(url('admin/print-yearly-report')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> <?php echo app('translator')->get('fleet.print'); ?></button>
        </div>
        <?php echo Form::close(); ?>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-warning">
              <div class="card-header">
                <h4 class="card-title"><?php echo app('translator')->get('fleet.chart'); ?> - <?php echo app('translator')->get('fleet.income'); ?></h4>
              </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-hover myTable">
                ...
                <thead>
                  <tr>
                    <th scope="row"><?php echo app('translator')->get('fleet.pl'); ?></th>
                    <td><strong><?php echo e(ayoubgr::get("currency")); ?><?php echo e($income_amt-$expense_amt); ?></strong></td>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <th scope="row"><?php echo app('translator')->get('fleet.income'); ?></th>
                    <td><?php echo e(ayoubgr::get("currency")); ?><?php echo e($income_amt); ?></td>
                  </tr>
                  <tr>
                    <th scope="row"><?php echo app('translator')->get('fleet.expenses'); ?></th>
                    <td><?php echo e(ayoubgr::get("currency")); ?><?php echo e($expense_amt); ?></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div class="col-md-4">
            <div class="card card-warning">
              <div class="card-header">
                <h4 class="card-title"><?php echo app('translator')->get('fleet.chart'); ?> - <?php echo app('translator')->get('fleet.incomeByCategory'); ?></h4>
              </div>
              <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-hover myTable">
                ...
                <thead>
                  <tr>
                    <th scope="row"><?php echo app('translator')->get('fleet.incomeByCategory'); ?></th>
                    <td><strong><?php echo e(ayoubgr::get("currency")); ?><?php echo e($tot); ?></strong></td>
                  </tr>
                </thead>
                <tbody>
                <?php $__currentLoopData = $income_by_cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td><?php echo e(ayoubgr::get("currency")); ?><?php echo e($exp->amount); ?></td>
                  </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
              </table>
          ...
          <div class="col-md-4">
            <div class="card card-warning">
              <div class="card-header">
                <h4 class="card-title"><?php echo app('translator')->get('fleet.chart'); ?> - <?php echo app('translator')->get('fleet.expensesByCategory'); ?></h4>
              </div>
              <div class="card-body">
              ...
              <table class="table table-bordered table-striped table-hover expTable">
                <thead>
                  <tr>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <th scope="row"><?php echo app('translator')->get('fleet.expensesByCategory'); ?></th>
                    <td><strong><?php echo e(ayoubgr::get("currency")); ?><?php echo e($tot); ?></strong></td>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo e(ayoubgr::get("currency")); ?><?php echo e($exp->expense); ?></td>
                  </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
              </table>
...
var c1 = [176,255,84,220,134,66,238];
  ...
  var chartData = {
      labels: ["<?php echo app('translator')->get('fleet.income'); ?>", "<?php echo app('translator')->get('fleet.expenses'); ?>"],
      datasets: [{
          type: 'pie',
          label: '',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/reports/yearly.blade.php ENDPATH**/ ?>