...
<li class="breadcrumb-item active"><?php echo app('translator')->get('menu.api_settings'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('menu.api_settings'); ?>
        </h3>
      </div>
      <div class="card-body">
        ...
        <div>
          <ul class="nav nav-pills custom">
            <li class="nav-item"><a href="#general" data-toggle="tab" class="nav-link active"> <?php echo app('translator')->get('menu.general_settings'); ?> <i class="fa"></i></a></li>
            <li class="nav-item"><a href="#firebase" data-toggle="tab" class="nav-link"> <?php echo app('translator')->get('fleet.firebase_settings'); ?> <i class="fa"></i></a></li>
            <li class="nav-item"><a href="#serverkey" data-toggle="tab" class="nav-link"> <?php echo app('translator')->get('fleet.app_notification'); ?> <i class="fa"></i></a></li>
            <li class="nav-item"><a href="#maps" data-toggle="tab" class="nav-link"> <?php echo app('translator')->get('fleet.maps'); ?> <i class="fa"></i></a></li>
          </ul>
        </div>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="tab-pane active" id="general">
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  <h6><?php echo Form::label('api',__('fleet.api'),['class'=>"form-label"]); ?>

                    
                  </h6>
                  <label class="switch">
                  <input type="checkbox" class="api" id="api" name="name[api]" value="1"  <?php if(ayoubgr::api('api') == "1"): ?> checked <?php endif; ?>>
                  <span class="slider round"></span>
                  </label>
                </div>

                <?php if(ayoubgr::api('api') == "1"): ?>
                <div class="form-group col-md-3">
                  <h6><?php echo Form::label('google_api',__('fleet.google_places_api'),['class'=>"form-label"]); ?> 
                    <a data-toggle="modal" data-target="#myModal2"><i class="fa fa-info-circle fa-lg" aria-hidden="true"  style="color: #8639dd"></i></a> <br>
                    <strong class="text-muted">(<a href="https://docs.listingprowp.com/knowledgebase/how-to-get-map-working-with-google-api-key/" target="blank"><?php echo app('translator')->get('fleet.api_guide'); ?></a>)</strong>
                  </h6>
                  <label class="switch">
                  <input type="checkbox" name="name[google_api]" value="1" <?php if(ayoubgr::api('google_api') == "1"): ?> checked <?php endif; ?>>
                  <span class="slider round"></span>
                  </label>
                </div>
                ...
                <div class="form-group col-md-3">
                  ...
                  <label class="switch">
                  <input type="checkbox" name="name[anyone_register]" value="1" <?php if(ayoubgr::api('anyone_register') == "1"): ?> checked <?php endif; ?>>
                  <span class="slider round"></span>
                  </label>
                </div>

                <div class="form-group col-md-3">
                  <h6><?php echo Form::label('driver_review',__('fleet.driver_review'),['class'=>"form-label"]); ?>

                    <a data-toggle="modal" data-target="#myModal3"><i class="fa fa-info-circle fa-lg" aria-hidden="true"  style="color: #8639dd"></i></a>
                  </h6>
                  <label class="switch">
                  <input type="checkbox" name="name[driver_review]" value="1" <?php if(ayoubgr::api('driver_review') == "1"): ?> checked <?php endif; ?>>
                  <span class="slider round"></span>
                  </label>
                </div>
                ...
                <div class="form-group col-md-12">
                  ...
                  ayoubgr::api('region_availability'),['class'=>"form-control"]); ?>
                ...
                <div class="form-group col-md-4">
                  ...
                  <?php echo Form::number('name[max_trip]',ayoubgr::api('max_trip'),['class'=>"form-control trip","required"]); ?>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <?php echo Form::number('name[booking]',ayoubgr::api('booking'),['class'=>"form-control",'required']); ?>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <?php echo Form::number('name[cancel]',ayoubgr::api('cancel'),['class'=>"form-control"]); ?>
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <input type="submit" class="form-control btn btn-success api_btn" value="<?php echo app('translator')->get('fleet.save'); ?>" />
                </div>
              </div>
            ...
            <div class="tab-pane" id="firebase">
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  ...
                  ayoubgr::api('db_url'),['class'=>"form-control",'required','placeholder'=>'for example: https://PROJECT.firebaseio.com']); ?>

                </div>
                

                <div class="col-md-6">
                  <button type="submit" class="btn btn-success" style="margin-right: 10px"><?php echo app('translator')->get('fleet.test'); ?></button>
                </div>
                <?php echo Form::close(); ?>
            ...
            <div class="tab-pane" id="serverkey">
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  ...
                  ayoubgr::api('server_key'),['class'=>"form-control",'required']); ?>
            ...
            <div class="tab-pane" id="maps">
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  ...
                  ayoubgr::api('api_key'),['class'=>"form-control",'required']); ?>

                </div>
                <div class="col-md-6">
                  <button type="submit" id="test_api" class="btn btn-success" style="margin-right: 10px"><?php echo app('translator')->get('fleet.test'); ?></button>
                </div>
                <?php echo Form::close(); ?>
              ...
              <div class="row" style="margin-top: 20px">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <ol class="text-muted">
                      <li>To Use Google Maps APIs, You must have a Separate billing account, a project, a New API key with Enabled Google APIS (For India Only). <a href="https://developers.google.com/maps/gmp-india-migration#action" target="_blank">Read more</a></li>
                      <li>You must create Billing account for <strong><a href="<?php echo e(asset('assets/images/billing-Account.png')); ?>">"Google Maps Platform"</a></strong> to Use Maps APIs.</li>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->get('fleet.api'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <p><?php echo app('translator')->get('fleet.api_info'); ?></p>
      </div>
...
<div id="myModal2" class="modal fade" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->get('fleet.google_places_api'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <p><?php echo app('translator')->get('fleet.google_places_api_info1'); ?></p>
        <p><?php echo app('translator')->get('fleet.google_places_api_info2'); ?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo app('translator')->get('fleet.close'); ?></button>
      </div>
...
<div id="myModal3" class="modal fade" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->get('fleet.driver_review'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <p><?php echo app('translator')->get('fleet.driver_review_info'); ?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo app('translator')->get('fleet.close'); ?></button>
      </div>
...
<div id="myModal4" class="modal fade" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->get('fleet.legacy_key'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <p><?php echo app('translator')->get('fleet.legacy_key_info'); ?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo app('translator')->get('fleet.close'); ?></button>
      </div>
...
<div id="myModal5" class="modal fade" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->get('fleet.db_url'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <p><?php echo app('translator')->get('fleet.db_url_info'); ?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo app('translator')->get('fleet.close'); ?></button>
      </div>
...
<div id="myModal6" class="modal fade" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->get('fleet.google_maps'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <p><?php echo app('translator')->get('fleet.google_maps_info'); ?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo app('translator')->get('fleet.close'); ?></button>
      </div>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/utilities/api_settings.blade.php ENDPATH**/ ?>