        ...
        <div class="row">
          <div class="col-md-4 col-sm-12">
            <h4>  <?php echo app('translator')->get('fleet.frontend_settings'); ?><span id="change" class="text-muted">
              <?php if(ayoubgr::frontend('enable')==1): ?>
          ...
          <div class="col-md-3 col-sm-12">
            <label class="switch">
              <input type="checkbox" name="enable" value="1" id="enable" <?php if(ayoubgr::frontend('enable')==1): ?> checked <?php endif; ?>>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="about" class="form-control" rows="3" required><?php echo e(ayoubgr::frontend('about_us')); ?></textarea>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <?php echo Form::number('customer_support', ayoubgr::frontend('customer_support') ,['class' => 'form-control','required']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <?php echo Form::number('phone', ayoubgr::frontend('contact_phone') ,['class' => 'form-control','required']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <?php echo Form::email('email',  ayoubgr::frontend('contact_email') ,['class' => 'form-control','required']); ?>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="about_description" class="form-control" rows="3" required><?php echo e(ayoubgr::frontend('about_description')); ?></textarea>
            </div>
          </div>
            <div class="col-md-6">
              <div class="form-group">
              ...
              <?php echo Form::text('about_title', ayoubgr::frontend('about_title') ,['class' => 'form-control','required']); ?>
            ...
            <select id='language' name='language' class="form-control" required>
              <option value="">-</option>              
              <?php ($language = ayoubgr::frontend("language")); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::text('faq_link', ayoubgr::frontend('faq_link') ,['class' => 'form-control']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::number('cities', ayoubgr::frontend('cities') ,['class' => 'form-control','required','min'=>0]); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::number('vehicles', ayoubgr::frontend('vehicles') ,['class' => 'form-control','required','min'=>0]); ?>

            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <?php echo Form::label('booking_time',__('fleet.booking_time'), ['class' => 'form-label']); ?>

              <?php echo Form::number('booking_time', ayoubgr::frontend('booking_time') ,['class' => 'form-control','required','min'=>1,'step'=>1]); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::text('cancellation', ayoubgr::frontend('cancellation') ,['class' => 'form-control']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::text('terms', ayoubgr::frontend('terms') ,['class' => 'form-control']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::text('privacy_policy', ayoubgr::frontend('privacy_policy') ,['class' => 'form-control']); ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <?php echo Form::text('facebook', ayoubgr::frontend('facebook') ,['class' => 'form-control']); ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <?php echo Form::text('twitter', ayoubgr::frontend('twitter') ,['class' => 'form-control']); ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <?php echo Form::text('instagram', ayoubgr::frontend('instagram') ,['class' => 'form-control']); ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <?php echo Form::text('linkedin', ayoubgr::frontend('linkedin') ,['class' => 'form-control']); ?>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-3 col-sm-12">
              ...
              <label class="switch">
                <input type="checkbox" name="approval_required" value="1" id="approval_required" <?php if(ayoubgr::frontend('admin_approval')==1): ?> checked <?php endif; ?>>
                <span class="slider round"></span>
              </label>
            </div>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/utilities/frontend.blade.php ENDPATH**/ ?>