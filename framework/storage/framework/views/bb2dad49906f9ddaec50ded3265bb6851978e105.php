                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="hero-content--home w-100 text-center mt-4">
                            <h5 class="light primary"><?php echo e(ayoubgr::frontend('contact_phone')); ?></h5>
                        ...
                        <form action="<?php echo e(url('book')); ?>" class="mt-4 w-100" method="POST" id="booking_form">
                            ...
                            <div class="form-inputs mt-5 w-100">
                                <div class="row w-100 m-0 p-0">
                                    ...
                                    <?php if(ayoubgr::frontend('admin_approval')==0 && ayoubgr::api('api_key') != null): ?>
                                    <div class="col-lg-12">
                                        <div class="checkboxes flex-row-center">
...
<?php if(ayoubgr::api('google_api') == "1"): ?>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(ayoubgr::api('api_key')); ?>&libraries=places&callback=initMap" async defer></script>
<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/frontend/home.blade.php ENDPATH**/ ?>