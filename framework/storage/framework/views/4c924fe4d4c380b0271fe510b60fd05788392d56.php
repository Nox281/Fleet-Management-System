...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    <div class="login-logo">
      <center> <img src="<?php echo e(asset('assets/images/'. ayoubgr::get('logo_img') )); ?>" height="140px" width="300px" />
      </center>
    </div>
    <!-- /.login-logo -->
    <div class="card">
          ...
          <div class="form-group has-feedback">
            <div class="input-group">
              <input type="password" class="form-control <?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>"
                placeholder="<?php echo app('translator')->get('passwords.password'); ?>" id="password" name="password" required>
              <div class="input-group-append">
...
</html><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/auth/login.blade.php ENDPATH**/ ?>