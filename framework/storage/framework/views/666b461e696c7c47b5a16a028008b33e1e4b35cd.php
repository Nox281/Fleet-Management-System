      ...
      <div class="card-body">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="info-tab">
            <?php echo Form::open(['route' => 'vehicles.store','files'=>true,
            ...
            <div class="row card-body">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-xs-6">
                    <select name="make_id" class="form-control" required id="make_id">
                      ...
                      <option value="<?php echo e($make->id); ?>"><?php echo e($make->make); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <?php endif; ?>
                  <div class="col-xs-6">
                    <?php echo Form::number('int_mileage', null,['class' => 'form-control','required']); ?>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-6">
                    <?php echo Form::select('engine_type',["Petrol"=>"Petrol","Diesel"=>"Diesel"],null,['class' =>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/vehicles/create.blade.php ENDPATH**/ ?>