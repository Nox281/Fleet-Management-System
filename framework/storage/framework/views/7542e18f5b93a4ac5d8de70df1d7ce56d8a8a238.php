...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.new_booking'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">
          <?php echo app('translator')->get('fleet.new_booking'); ?>
        </h3>
      </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php if(Auth::user()->user_type != "C"): ?> <a href="#" data-toggle="modal"
                data-target="#exampleModal"><?php echo app('translator')->get('fleet.new_customer'); ?></a> <?php endif; ?>
              <select id="customer_id" name="customer_id" class="form-control" required>
                <option value="">-</option>
                <?php if(Auth::user()->user_type == "C"): ?>
                <option value="<?php echo e(Auth::user()->id); ?>" data-address="<?php echo e(Auth::user()->getMeta('address')); ?>"
                  data-address2="" data-id="<?php echo e(Auth::user()->id); ?>" selected><?php echo e(Auth::user()->name); ?>

                </option>
                <?php else: ?>
                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($customer->id); ?>" data-address="<?php echo e($customer->getMeta('address')); ?>" data-address2=""
                  data-id="<?php echo e($customer->id); ?>"><?php echo e($customer->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
              </select>
            </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select id="vehicle_id" name="vehicle_id" class="form-control" required>
                ...
                <option value="<?php echo e($vehicle->id); ?>" data-driver="<?php echo e($vehicle->driver_id); ?>"><?php echo e($vehicle->maker->make); ?> -
                  <?php echo e($vehicle->vehiclemodel->model); ?> - <?php echo e($vehicle->license_plate); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
          </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel"><?php echo app('translator')->get('fleet.new_customer'); ?></h4>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-info"><?php echo app('translator')->get('fleet.save_cust'); ?></button>
      </div>
    </div>
    <?php echo Form::close(); ?>
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if(customers == 0){
          new PNotify({
            title: 'Failed!',
            text: "<?php echo app('translator')->get('fleet.email_already_taken'); ?>",
            type: 'error'
          });
        }
        else{
          ...
          new PNotify({
            title: 'Success!',
            text: '<?php echo app('translator')->get("fleet.add_customer"); ?>',
            type: 'success'
          });
        }
      },
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if(data.pickup_addr != ""){
          new PNotify({
            title: 'Success!',
            text: "<?php echo app('translator')->get('fleet.prev_addr'); ?>",
            type: 'success'
          });
        }
      },
...
<?php if(ayoubgr::api('google_api') == "1"): ?>
<script>
  function initMap() {
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(ayoubgr::api('api_key')); ?>&libraries=places&callback=initMap"
  async defer></script>
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/bookings/create.blade.php ENDPATH**/ ?>