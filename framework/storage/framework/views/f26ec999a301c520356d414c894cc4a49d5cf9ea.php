  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.manageUsers'); ?> &nbsp;
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Users add')): ?><a href="<?php echo e(route('users.create')); ?>" class="btn btn-success" title="<?php echo app('translator')->get('fleet.addUser'); ?>"><i
        ...
        <table class="table" id="ajax_data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th>#</th>
              <th><?php echo app('translator')->get('fleet.profile_photo'); ?></th>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    var table = $('#ajax_data_table').DataTable({
         ...
         serverSide: true,
         ajax: {
          url: "<?php echo e(url('admin/users-fetch')); ?>",
          type: 'POST',
          data:{}
         },
         columns: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/users/index.blade.php ENDPATH**/ ?>