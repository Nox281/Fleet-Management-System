...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.add_order'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">
          <?php echo app('translator')->get('fleet.create_workorder'); ?>
        </h3>
      </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select id="vehicle_id" name="vehicle_id" class="form-control" required>
                ...
                <option value="<?php echo e($vehicle->id); ?>"><?php echo e($vehicle->maker->make); ?> - <?php echo e($vehicle->vehiclemodel->model); ?> -
            ...
            <div class="form-group">
              <?php echo Form::label('meter',ayoubgr::get('dis_format')." ".__('fleet.reading'), ['class' => 'form-label']); ?>

              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"><?php echo e(ayoubgr::get('dis_format')); ?></span>
                </div>
            ...
            <div class="form-group">
              ...
              <?php echo Form::select('status',["Pending"=>"Pending", "Processing"=>"Processing",
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <?php echo Form::label('mechanic_id',__('fleet.mechanics'), ['class' => 'form-label']); ?>

              <select id="mechanic_id" name="mechanic_id" class="form-control" required>
                <option value="">-</option>
                <?php $__currentLoopData = $mechanic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row" style="margin-bottom: 25px;">
          <div class="col-md-6">
            <div class="form-group"> <label class="form-label"><?php echo app('translator')->get('fleet.selectPart'); ?></label> <select
                id="select_part" class="form-control" name="part_list">
                <option></option><?php $__currentLoopData = $parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($part->id); ?>" title="<?php echo e($part->title); ?>"
                  qty="<?php echo e($part->stock); ?>" price="<?php echo e($part->unit_cost); ?>"><?php echo e($part->title); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select> </div>
          </div>
          <div class="col-md-6" style="margin-top: 30px">
            <button type="button" class="btn btn-warning attach"><?php echo app('translator')->get('fleet.attachPart'); ?></button>
          </div>
        </div>
        <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/work_orders/create.blade.php ENDPATH**/ ?>