        ...
        <div class="row">          
          <div class="col-md-6">
            <div class="form-group">
              ...
              ayoubgr::chat('pusher_app_id'),['class'=>"form-control"]); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              ayoubgr::chat('pusher_app_key'),['class'=>"form-control razorpay"]); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              ayoubgr::chat('pusher_app_secret'),['class'=>"form-control"]); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              ayoubgr::chat('pusher_app_cluster'),['class'=>"form-control"]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/utilities/chat_settings.blade.php ENDPATH**/ ?>