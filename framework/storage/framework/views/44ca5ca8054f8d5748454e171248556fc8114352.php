        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::text('sid', ayoubgr::twilio('sid') ,['class' => 'form-control','required']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::text('token', ayoubgr::twilio('token') ,['class' => 'form-control','required']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <?php echo Form::text('from', ayoubgr::twilio('from') ,['class' => 'form-control','required']); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo Form::textarea('customer_message', ayoubgr::twilio('customer_message') ,['class' => 'form-control','required','size'=>'30x3']); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo Form::textarea('driver_message', ayoubgr::twilio('driver_message') ,['class' => 'form-control','required','size'=>'30x3']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/twilio/index.blade.php ENDPATH**/ ?>