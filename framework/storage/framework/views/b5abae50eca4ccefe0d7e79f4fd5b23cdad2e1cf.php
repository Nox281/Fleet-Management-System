      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="form-group col-md-4">
            ...
            ayoubgr::get('app_name'),['class'=>"form-control",'required']); ?>
          ...
          <div class="form-group col-md-4">
            ...
            ayoubgr::get('email'),['class'=>"form-control",'required']); ?>
          ...
          <div class="form-group col-md-4">
            ...
            ayoubgr::get('badd1'),['class'=>"form-control",'required']); ?>
          ...
          <div class="form-group col-md-4">
            ...
            ayoubgr::get('badd2'),['class'=>"form-control",'required']); ?>
          ...
          <div class="form-group col-md-4">
            ...
            ayoubgr::get('city'),['class'=>"form-control",'required']); ?>
          ...
          <div class="form-group col-md-4">
            ...
            ayoubgr::get('state'),['class'=>"form-control",'required']); ?>
          ...
          <div class="form-group col-md-3">
            ...
            ayoubgr::get('country'),['class'=>"form-control",'required']); ?>
          ...
          <div class="form-group col-md-3">
            ...
            <?php echo Form::select('name[dis_format]', ['km' => 'km', 'miles' => 'miles'], ayoubgr::get("dis_format"),['class'=>"form-control",'required']); ?>
          ...
          <div class="form-group col-md-3">
            ...
            <?php echo Form::select('name[fuel_unit]', ['gallon' => 'gallon', 'liter' => 'liter'], ayoubgr::get("fuel_unit"),['class'=>"form-control",'required']); ?>
          ...
          <div class="form-group col-md-4">
            <?php echo Form::label('time_interval',__('fleet.defaultTimeInterval'),['class'=>"form-label"]); ?>
              ...
              <div class="input-group mb-3">
                <?php echo Form::number('name[time_interval]',ayoubgr::get('time_interval'),['class'=>"form-control",'required','min'=>1]); ?>
          ...
          <div class="form-group col-md-4">
            ...
            <?php if(ayoubgr::get('icon_img')!= null): ?>
          ...
          <div class="form-group col-md-4">
            ...
            <?php if(ayoubgr::get('logo_img')!= null): ?>
          ...
          <div class="form-group col-md-3">
            ...
            ayoubgr::get('currency'),['class'=>"form-control",'required']); ?>

          </div>
          <div class="form-group col-md-3">
            <?php echo Form::label('date_format',__('fleet.date_format'),['class'=>"form-label"]); ?>

            <?php echo Form::select('name[date_format]', ['d-m-Y' => 'dd-mm-yyyy ('.date('d-m-Y').')', 'Y-m-d' => 'yyyy-mm-dd ('.date('Y-m-d').')','m-d-Y'=>'mm-dd-yyyy ('.date('m-d-Y').')'], ayoubgr::get("date_format"),['class'=>"form-control",'required']); ?>
          ...
          <div class="form-group col-md-3">
            ...
            ayoubgr::get('tax_no'),['class'=>"form-control",'required']); ?>
          ...
          <?php ($udfs = json_decode(ayoubgr::get('tax_charge'))); ?>
          ...
          <div class="form-group col-md-12">
            ...
            ayoubgr::get('invoice_text'),['class'=>"form-control",'size'=>'30x3']); ?>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="name[web_footer]" id="web_footer" class="form-control"><?php echo e(ayoubgr::get('web_footer')); ?></textarea>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <br>
              <label class="switch">
                <input type="checkbox" name="fuel_enable_driver" value="1" id="fuel_enable_driver" <?php if(ayoubgr::get('fuel_enable_driver')==1): ?> checked <?php endif; ?>>
          ...
          <div class="col-md-3">
            <div class="form-group">
              <?php echo Form::label('income_enable_driver',__('fleet.income_enable_driver'), ['class' => 'form-label']); ?>

              <a data-toggle="modal" data-target="#myModal7"><i class="fa fa-info-circle fa-lg" aria-hidden="true"  style="color: #8639dd"></i></a>
              <br>
              <label class="switch">
                <input type="checkbox" name="income_enable_driver" value="1" id="income_enable_driver" <?php if(ayoubgr::get('income_enable_driver')==1): ?> checked <?php endif; ?>>
                <span class="slider round"></span>
              </label>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              <?php echo Form::label('expense_enable_driver',__('fleet.expense_enable_driver'), ['class' => 'form-label']); ?>

              <a data-toggle="modal" data-target="#myModal8"><i class="fa fa-info-circle fa-lg" aria-hidden="true"  style="color: #8639dd"></i></a>
              <br>
              <label class="switch">
                <input type="checkbox" name="expense_enable_driver" value="1" id="expense_enable_driver" <?php if(ayoubgr::get('expense_enable_driver')==1): ?> checked <?php endif; ?>>
                <span class="slider round"></span>
              </label>
            </div>
          </div>          
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>
          <a href="https://fleetdocs.ayoubgr.space/explore-features/settings/general-settings" target="_blank"><?php echo app('translator')->get('fleet.click_here'); ?></a>
        </p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo app('translator')->get('fleet.close'); ?></button>
...
<div id="myModal7" class="modal fade" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->get('fleet.income_enable_driver'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <p><?php echo app('translator')->get('fleet.income_enable_driver_info'); ?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo app('translator')->get('fleet.close'); ?></button>
      </div>
...
<div id="myModal8" class="modal fade" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo app('translator')->get('fleet.expense_enable_driver'); ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <p><?php echo app('translator')->get('fleet.expense_enable_driver_info'); ?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo app('translator')->get('fleet.close'); ?></button>
      </div>
...
<script type="text/javascript">
  ...
  $('.view1').click(function(){
    $('#myModal3 .modal-body .myimg').attr( "src","<?php echo e(asset('assets/images/'. ayoubgr::get('icon_img') )); ?>");
    $('#myModal3 .modal-body .myimg').removeAttr( "height");
    $('#myModal3 .modal-body .myimg').removeAttr( "width");
  });

  $('.view2').click(function(){
    $('#myModal3 .modal-body .myimg').attr( "src","<?php echo e(asset('assets/images/'. ayoubgr::get('logo_img') )); ?>");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/utilities/settings.blade.php ENDPATH**/ ?>