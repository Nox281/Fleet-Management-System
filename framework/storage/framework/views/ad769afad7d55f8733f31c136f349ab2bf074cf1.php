...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.customers'); ?></li>
  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.manage_customers'); ?>
        &nbsp; <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Customer add')): ?><a href="<?php echo e(route('customers.create')); ?>" class="btn btn-success" title="<?php echo app('translator')->get('fleet.add_new'); ?>"><i class="fa fa-plus"></i></a><?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Customer import')): ?>&nbsp;&nbsp;<button data-toggle="modal" data-target="#import" class="btn btn-warning"><?php echo app('translator')->get('fleet.import'); ?></button><?php endif; ?>
        </h3>
      </div>
        ...
        <table class="table" id="ajax_data_table" style="padding-bottom: 25px">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->get('fleet.gender'); ?></th>
              <th><?php echo app('translator')->get('fleet.address'); ?></th>
          ...
          <tfoot>
            <tr>
              <th>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Customer delete')): ?><button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled title="<?php echo app('translator')->get('fleet.delete'); ?>"><i class="fa fa-trash"></i></button><?php endif; ?>
              </th>
              <th><?php echo app('translator')->get('fleet.name'); ?></th>
              <th><?php echo app('translator')->get('fleet.email'); ?></th>
              <th><?php echo app('translator')->get('fleet.phone'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/customers/index.blade.php ENDPATH**/ ?>