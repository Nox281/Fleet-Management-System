...
<?php ($currency=ayoubgr::get('currency')); ?>
...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.manage_income'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.addRecord'); ?></h3>
      </div>
      <div class="card-body">
        <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <select id="vehicle_id" name="vehicle_id" class="form-control vehicles" required style="width: 100%">
                  ...
                  <option value="<?php echo e($vehicle->id); ?>" data-mileage="<?php echo e($vehicle->mileage); ?>"><?php echo e($vehicle->maker->make); ?>-<?php echo e($vehicle->vehiclemodel->model); ?>-<?php echo e($vehicle->license_plate); ?></option>
        ...
        <div class="row">
          <div class="col-md-3" style="margin-top: 5px;">
            ...
            <div class="input-group">
              <div class="input-group-prepend">
              <span class="input-group-text"><?php echo e($currency); ?></span></div>
          ...
          <div class="col-md-3" style="margin-top: 5px;">
            <?php ($tax_percent=0); ?>
            <?php if(ayoubgr::get('tax_charge') != "null"): ?>
          ...
          <div class="col-md-6" style=" margin-top: 5px;">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Transactions add')): ?><button type="submit" class="btn btn-success"><?php echo app('translator')->get('fleet.add'); ?></button><?php endif; ?>
          </div>
          <?php echo Form::close(); ?>
      ...
      <div class="card-header">
        <div class="panel-heading">
          <div class="row">
            <div class="col-md-4">
              <h3 class="card-title">
                <?php echo app('translator')->get('fleet.todayIncome'); ?>: <strong><span id="total_today"> <?php echo e($currency." ". $total); ?> </span> </strong>
              </h3>
            </div>
        ...
        <table class="table" id="data_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php echo e($row->vehicle->maker->make); ?>

              <?php endif; ?>
              </td>
              <td>
              <?php if($row->vehicle_id != null): ?>
              <?php echo e($row->vehicle->vehiclemodel->model); ?>
              ...
              <td><?php echo e($currency); ?> <?php echo e($row->amount); ?></td>
              ...
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Transactions delete')): ?><button type="button" class="btn btn-danger delete" data-id="<?php echo e($row->id); ?>" title="<?php echo app('translator')->get('fleet.delete'); ?>"><span class="fa fa-times" aria-hidden="true"></span></button><?php endif; ?>
              <?php echo Form::close(); ?>
          ...
          <tfoot>
            <tr>
              <th>
                <?php if($today->count() > 0): ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Transactions delete')): ?><button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled title="<?php echo app('translator')->get('fleet.delete'); ?>" ><i class="fa fa-trash"></i></button><?php endif; ?>
                <?php endif; ?>
              </th>
              <th><?php echo app('translator')->get('fleet.make'); ?></th>
              <th><?php echo app('translator')->get('fleet.model'); ?></th>
...
$(document).ready(function() {
  ...
  $('#income_type').select2({placeholder: "<?php echo app('translator')->get('fleet.incomeType'); ?>"});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/income/index.blade.php ENDPATH**/ ?>