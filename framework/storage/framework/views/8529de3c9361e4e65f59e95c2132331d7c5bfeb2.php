  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
          <?php echo app('translator')->get('menu.notifications'); ?>
        </h3>
      </div>
        ...
        <table class="table" id="data_table">
          ...
          <?php if($data->id == $notification->data['vid']): ?>
            ...
            <tr>
              ...
              <td>
                <?php echo e($data->maker->make); ?> -
                <?php echo e($data->vehiclemodel->model); ?>

              </td>
              <td><?php echo e($msg); ?> <?php echo e(date(ayoubgr::get('date_format'),strtotime($notification->data['msg']))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/notifications/vehicle_notification.blade.php ENDPATH**/ ?>