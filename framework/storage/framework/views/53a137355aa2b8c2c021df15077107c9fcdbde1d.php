                    ...
                    <div class="col-md-6">
                        <div class="contact-tile">
                            ...
                            <div class="contact-tile-details">
                                ...
                                <p><?php echo app('translator')->get('frontend.contact_us_at'); ?> <strong class="primary"><?php echo e(ayoubgr::frontend('customer_support')); ?></strong> </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="contact-tile">
                            ...
                            <div class="contact-tile-details">
                                ...
                                <p><?php echo app('translator')->get('frontend.contact_us_at'); ?> <strong class="primary"><?php echo e(ayoubgr::frontend('contact_phone')); ?></strong> </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 ">
                        <div class="contact-tile">
                            ...
                            <div class="contact-tile-details">
                                ...
                                <p><?php echo app('translator')->get('frontend.send_your_email'); ?> <strong class="primary"><?php echo e(ayoubgr::frontend('contact_email')); ?></strong> </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <section class="contact-map-section mb-5">
            <div class="map w-100 h-100">
                ...
                <script>
                    ...
                    var address = '<?php echo e(ayoubgr::get('badd1') . ", " . ayoubgr::get('badd2') . ", " . ayoubgr::get('city') . ", " . ayoubgr::get('state') . ", " . ayoubgr::get('country') . "."); ?>';
                ...
                <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(ayoubgr::api('api_key')); ?>&callback=initMap" async defer></script>
                <!-- Google map ends -->
            </div>
            ...
            <div class="contact-address">
                <h4 class="karla">
                    ...
                    <span class="p pt-1 text-center"> &emsp;<?php echo e(ayoubgr::get('badd1') . ", " . ayoubgr::get('badd2') . ", " . ayoubgr::get('city') . ", " . ayoubgr::get('state') . ", " . ayoubgr::get('country') . "."); ?>
            ...
            <div class="container mb-4">
                ...
                <div class="contact-social-icons">
                    <div class="social-icon--facebook">
                        <a href="<?php echo e(ayoubgr::frontend('facebook')); ?>"> <i class="fab fa-facebook-f"></i></a>
                    </div>
                    <div class="social-icon--twitter">
                        <a href="<?php echo e(ayoubgr::frontend('twitter')); ?>"> <i class="fab fa-twitter"></i></a>
                    </div>
                    <div class="social-icon--instagram">
                        <a href="<?php echo e(ayoubgr::frontend('instagram')); ?>"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/frontend/contact.blade.php ENDPATH**/ ?>