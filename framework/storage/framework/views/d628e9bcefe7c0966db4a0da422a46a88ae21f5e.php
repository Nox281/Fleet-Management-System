                ...
                <?php if($bookings->count() > 0): ?>
                    ...
                    <div class="booking">
                        <span class="booking-date">
                            <?php echo e(date((ayoubgr::get('date_format')) ? ayoubgr::get('date_format') : 'd-m-Y', strtotime($booking->journey_date))); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-3">
                                <div class="pills-container">
                                    ...
                                    <?php if($booking->tax_total): ?><span class="pill dark"> <span class="rupees"> <?php echo e(ayoubgr::get('currency')); ?> </span><?php echo e($booking->tax_total); ?></span><?php endif; ?>
                                    <?php if($booking->total_kms): ?><span class="pill dark"> <img src="<?php echo e(asset('assets/frontend/icons/fleet-kilometer.png')); ?>" alt=""> <?php echo e($booking->total_kms); ?> <?php echo e(ayoubgr::get('dis_format')); ?> </span><?php endif; ?>
                                    
                                </div>
                            </div>
                            <div class="col-sm-12 mt-3">
                                <div class="pills-container">
                                    <?php ($methods = json_decode(ayoubgr::payment('method'))); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/frontend/booking_history.blade.php ENDPATH**/ ?>