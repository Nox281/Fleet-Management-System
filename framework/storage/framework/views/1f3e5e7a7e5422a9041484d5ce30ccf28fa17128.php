  ...
  <div class="col-md-12">
    ...
    <div class="card card-warning">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.edit_vehicle'); ?></h3>
      </div>
      ...
      <div class="card-body">
        <div class="nav-tabs-custom">
          <ul class="nav nav-pills custom">
            ...
            <li class="nav-item"><a class="nav-link" href="#insurance" data-toggle="tab"> <?php echo app('translator')->get('fleet.insurance'); ?> <i
                  class="fa"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="#acq-tab" data-toggle="tab"> <?php echo app('translator')->get('fleet.purchase_info'); ?> <i
                  class="fa"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="#driver" data-toggle="tab"> <?php echo app('translator')->get('fleet.assign_driver'); ?> <i
                  class="fa"></i></a></li>
          </ul>
        </div>
        <div class="tab-content">
          <div class="tab-pane active" id="info-tab">
            <?php echo Form::open(['route' =>['vehicles.update',$vehicle->id],'files'=>true,
            ...
            <div class="row card-body">
              <div class="col-md-6">
                <div class="form-group">
                  <?php echo Form::label('make_id', __('fleet.SelectVehicleMake'), ['class' => 'col-xs-5 control-label']); ?>
                  ...
                  <div class="col-xs-6">
                    <select name="make_id" class="form-control" required id="make_id">
                      ...
                      <option value="<?php echo e($make->id); ?>" <?php if($make->id == $vehicle->make_id): ?> selected <?php endif; ?>><?php echo e($make->make); ?>
                ...
                <div class="form-group">
                  <?php echo Form::label('model_id', __('fleet.SelectVehicleModel'), ['class' => 'col-xs-5 control-label']); ?>

                  <div class="col-xs-6">
                    <select name="model_id" class="form-control" required id="model_id">
                      <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($model->id); ?>" <?php if($model->id == $vehicle->model_id): ?> selected <?php endif; ?>><?php echo e($model->model); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-6">
                    <select name="type_id" class="form-control" required id="type_id">
                      ...
                      <option value="<?php echo e($type->id); ?>" <?php if($vehicle->type_id == $type->id): ?> selected
                        <?php endif; ?>><?php echo e($type->displayname); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <?php if(ayoubgr::get('dis_format') == "km"): ?>
                  <?php if(ayoubgr::get('fuel_unit') == "gallon"): ?> <?php echo Form::label('average',
                  __('fleet.average')."(".__('fleet.kmpg').")", ['class' => 'col-xs-5 control-label']); ?> <?php else: ?> <?php echo Form::label('average', __('fleet.average')."(".__('fleet.kmpl').")", ['class' => 'col-xs-5
                  control-label']); ?> <?php endif; ?>
                  <?php else: ?>
                  <?php if(ayoubgr::get('fuel_unit') == "gallon"): ?><?php echo Form::label('average',
                  __('fleet.average')."(".__('fleet.mpg').")", ['class' => 'col-xs-5 control-label']); ?> <?php else: ?> <?php echo Form::label('average', __('fleet.average')."(".__('fleet.mpl').")", ['class' => 'col-xs-5
                  control-label']); ?> <?php endif; ?>
                  <?php endif; ?>
                  <div class="col-xs-6">
                ...
                <div class="form-group">
                  <?php if(ayoubgr::get('dis_format') == "km"): ?>
                  <?php echo Form::label('int_mileage', __('fleet.intMileage')."(".__('fleet.km').")", ['class' => 'col-xs-5
                  control-label']); ?>

                  <?php else: ?>
                  <?php echo Form::label('int_mileage', __('fleet.intMileage')."(".__('fleet.miles').")", ['class' => 'col-xs-5
                  control-label']); ?>
                ...
                <div class="form-group">
                  <?php echo Form::label('reg_exp_date',__('fleet.reg_exp_date'), ['class' => 'col-xs-5 control-label
                  required']); ?>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-ms-6" style="margin-left: -140px">
                      <label class="switch">
                        <input type="checkbox" name="in_service" value="1" <?php if($vehicle->in_service == '1'): ?> checked
                        <?php endif; ?>>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <?php echo Form::label('color_id', __('fleet.SelectVehicleColor'), ['class' => 'col-xs-5 control-label']); ?>
                  ...
                  <div class="col-xs-6">
                    <select name="color_id" class="form-control" required id="color_id">
                      ...
                      <option value="<?php echo e($color->id); ?>" <?php if($color->id == $vehicle->color_id): ?>selected
                        <?php endif; ?>><?php echo e($color->color); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-6">
                    <?php echo Form::select('engine_type',["Petrol"=>"Petrol","Diesel"=>"Diesel"],$vehicle->engine_type,['class' =>
                ...
                <div class="form-group">
                  <?php echo Form::label('lic_exp_date',__('fleet.lic_exp_date'), ['class' => 'col-xs-5 control-label
                  required']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-6">
                    <select id="group_id" name="group_id" class="form-control">
                      ...
                      <option value="<?php echo e($group->id); ?>" <?php if($group->id == $vehicle->group_id): ?> selected
                        <?php endif; ?>><?php echo e($group->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group"> <label class="form-label text-uppercase"><?php echo e($key); ?></label> <input
                        type="text" name="udf[<?php echo e($key); ?>]" class="form-control" required value="<?php echo e($value); ?>"></div>
                  </div>
                  <div class="col-md-4">
          ...
          <div class="tab-pane " id="insurance">
            <?php echo Form::open(['url' => 'admin/store_insurance','files'=>true,
            ...
            <div class="row card-body">
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <?php echo Form::text('insurance_number', $vehicle->getMeta('ins_number'),['class' =>
                  'form-control','required']); ?>
            ...
            <div class="row card-body">
              <div class="col-md-12">
                <div class="card card-info">
                  <div class="card-header">
                    <h3 class="card-title"><?php echo app('translator')->get('fleet.acquisition'); ?> :<strong><?php if($vehicle->make_id): ?><?php echo e($vehicle->maker->make); ?><?php endif; ?> <?php if($vehicle->model_id): ?><?php echo e($vehicle->vehiclemodel->model); ?><?php endif; ?>
                        <?php echo e($vehicle->license_plate); ?></strong>
                    </h3>
                  </div>
                        ...
                        <table class="table">
                          ...
                          <tbody id="hvk">
                            ...
                            <tr>
                              ...
                              <td><?php echo e(ayoubgr::get('currency')." ". $row['exp_amount']); ?></td>
                              <td>
                                <?php echo Form::open(['route'
                                ...
                                <button type="button" class="btn btn-danger del_info" data-vehicle="<?php echo e($vehicle->id); ?>"
                            ...
                            <tr>
                              ...
                              <td><strong><?php echo e(ayoubgr::get('currency')." ". $i); ?></strong></td>
                              <td></td>
                            </tr>
                            <?php endif; ?>
                          </tbody>
          ...
          <div class="tab-pane " id="driver">
            <div class="card-body">
              <?php echo Form::open(['url' => 'admin/assignDriver',
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select id="driver_id" name="driver_id[]" class="form-control w-100" multiple="true" required>
                    ...
                    <option value="<?php echo e($driver->id); ?>" <?php echo e($selected); ?>>
                      ...
                      ( <?php echo app('translator')->get('fleet.in_active'); ?> ) <?php endif; ?>
                    </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
...
<script type="text/javascript">
  ...
  $('#type_id').select2({placeholder:"<?php echo app('translator')->get('fleet.type'); ?>"});
  $('#make_id').select2({placeholder:"<?php echo app('translator')->get('fleet.SelectVehicleMake'); ?>"});
  $('#color_id').select2({placeholder:"<?php echo app('translator')->get('fleet.SelectVehicleColor'); ?>"});
  $('#model_id').select2({placeholder:"<?php echo app('translator')->get('fleet.SelectVehicleModel'); ?>"});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Flet\framework\resources\views/vehicles/edit.blade.php ENDPATH**/ ?>