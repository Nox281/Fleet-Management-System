...
class SettingSeed extends Seeder
{
    ...
    private function default_settings()
    {
        ...
        Settings::create(['label' => 'Website Footer', 'name' => 'web_footer', 'value' => '<p><span style="font-size: 16px;">© ayoubgr Solutions '.date('Y').'. All Rights Reserved.&nbsp;<span class="vertical-spacer d-none d-lg-inline">|</span>&nbsp;Powered By&nbsp;</span><a href="https://ayoubgr.com/" target="_blank" class="link"><span style="font-size: 16px;">ayoubgr</span></a></p>']);
    ...
    private function frontend_settings()
    {
        ...
        FrontendModel::create(['key_name' => 'language', 'key_value' => 'English-en']);
        FrontendModel::create(['key_name' => 'admin_approval', 'key_value' => 1]);
    ...
    private function twilio_settings()
    {
        DB::table('twilio_settings')->truncate();
