            ...
            <div class="tab-pane active" id="general">
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  ...
                  <label class="switch">
                  <input type="checkbox" class="api" id="api" name="name[api]" value="1"  @if(ayoubgr::api('api') == "1") checked @endif>
                  <span class="slider round"></span>
                  </label>
                </div>

                @if(ayoubgr::api('api') == "1")
                <div class="form-group col-md-3">
                  ...
                  <label class="switch">
                  <input type="checkbox" name="name[google_api]" value="1" @if(ayoubgr::api('google_api') == "1") checked @endif>
                  <span class="slider round"></span>
                  </label>
                </div>
                ...
                <div class="form-group col-md-3">
                  ...
                  <label class="switch">
                  <input type="checkbox" name="name[anyone_register]" value="1" @if(ayoubgr::api('anyone_register') == "1") checked @endif>
                  <span class="slider round"></span>
                  </label>
                </div>
                ...
                <div class="form-group col-md-3">
                  ...
                  <label class="switch">
                  <input type="checkbox" name="name[driver_review]" value="1" @if(ayoubgr::api('driver_review') == "1") checked @endif>
                  <span class="slider round"></span>
                  </label>
                </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  {!! Form::number('name[max_trip]',ayoubgr::api('max_trip'),['class'=>"form-control trip","required"]) !!}
                  </div>
                </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-3">
                    ...
                    {!! Form::number('name[booking]',ayoubgr::api('booking'),['class'=>"form-control",'required']) !!}
                  </div>
                </div>
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-3">
                    ...
                    {!! Form::number('name[cancel]',ayoubgr::api('cancel'),['class'=>"form-control"]) !!}
                  </div>
                </div>
                @endif
              </div>
            ...
            <div class="tab-pane" id="firebase">
              ...
              <div class="row">
                ...
                {{-- <div class="form-group col-md-6">
                  ...
                  {!! Form::text('db_secret',
                  ayoubgr::api('db_secret'),['class'=>"form-control",'required']) !!}
                </div> --}}
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <ol class="text-muted">
                      ...
                      <li>You must create Billing account for <strong><a href="{{ asset('assets/images/billing-Account.png') }}">"Google Maps Platform"</a></strong> to Use Maps APIs.</li>
