      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-3">
            ...
            {!! Form::select('name[dis_format]', ['km' => 'km', 'miles' => 'miles'], ayoubgr::get("dis_format"),['class'=>"form-control",'required']) !!}
          </div>

          <div class="form-group col-md-3">
            {!! Form::label('fuel_unit',__('fleet.fuel_unit'),['class'=>"form-label"]) !!}
            {!! Form::select('name[fuel_unit]', ['gallon' => 'gallon', 'liter' => 'liter'], ayoubgr::get("fuel_unit"),['class'=>"form-control",'required']) !!}
          </div>
          ...
          <div class="form-group col-md-4">
            {!! Form::label('time_interval',__('fleet.defaultTimeInterval'),['class'=>"form-label"]) !!}
              ...
              <div class="input-group mb-3">
                {!! Form::number('name[time_interval]',ayoubgr::get('time_interval'),['class'=>"form-control",'required','min'=>1]) !!}
          ...
          <div class="form-group col-md-3">
            ...
            {!! Form::select('name[date_format]', ['d-m-Y' => 'dd-mm-yyyy ('.date('d-m-Y').')', 'Y-m-d' => 'yyyy-mm-dd ('.date('Y-m-d').')','m-d-Y'=>'mm-dd-yyyy ('.date('m-d-Y').')'], ayoubgr::get("date_format"),['class'=>"form-control",'required']) !!}
          </div>
          <div class="form-group col-md-3">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="name[web_footer]" id="web_footer" class="form-control">{{ ayoubgr::get('web_footer') }}</textarea>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <br>
              <label class="switch">
                <input type="checkbox" name="fuel_enable_driver" value="1" id="fuel_enable_driver" @if(ayoubgr::get('fuel_enable_driver')==1) checked @endif>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <br>
              <label class="switch">
                <input type="checkbox" name="income_enable_driver" value="1" id="income_enable_driver" @if(ayoubgr::get('income_enable_driver')==1) checked @endif>
                <span class="slider round"></span>
              </label>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              ...
              <br>
              <label class="switch">
                <input type="checkbox" name="expense_enable_driver" value="1" id="expense_enable_driver" @if(ayoubgr::get('expense_enable_driver')==1) checked @endif>
                <span class="slider round"></span>
              </label>
            </div>
          </div>          
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>
          <a href="https://fleetdocs.ayoubgr.space/explore-features/settings/general-settings" target="_blank">@lang('fleet.click_here')</a>
        </p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">@lang('fleet.close')</button>
...
<script type="text/javascript">
  ...
  $('.view1').click(function(){
    $('#myModal3 .modal-body .myimg').attr( "src","{{ asset('assets/images/'. ayoubgr::get('icon_img') ) }}");
    $('#myModal3 .modal-body .myimg').removeAttr( "height");
    $('#myModal3 .modal-body .myimg').removeAttr( "width");
  });

  $('.view2').click(function(){
    $('#myModal3 .modal-body .myimg').attr( "src","{{ asset('assets/images/'. ayoubgr::get('logo_img') ) }}");
