      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-12">
            <label class="switch">
              <input type="checkbox" name="enable" value="1" id="enable" @if(ayoubgr::frontend('enable')==1) checked @endif>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="about" class="form-control" rows="3" required>{{ ayoubgr::frontend('about_us') }}</textarea>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!! Form::number('customer_support', ayoubgr::frontend('customer_support') ,['class' => 'form-control','required']) !!}
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!! Form::number('phone', ayoubgr::frontend('contact_phone') ,['class' => 'form-control','required']) !!}
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!! Form::email('email',  ayoubgr::frontend('contact_email') ,['class' => 'form-control','required']) !!}
              </div>
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="about_description" class="form-control" rows="3" required>{{ ayoubgr::frontend('about_description') }}</textarea>
            </div>
          </div>
            <div class="col-md-6">
              <div class="form-group">
              {!! Form::label('about_title',__('fleet.aboutFleetManagerTitle'), ['class' => 'form-label']) !!}
              {!! Form::text('about_title', ayoubgr::frontend('about_title') ,['class' => 'form-control','required']) !!}
            </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {!! Form::text('faq_link', ayoubgr::frontend('faq_link') ,['class' => 'form-control']) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('cities',__('fleet.cities_serving'), ['class' => 'form-label']) !!}
              {!! Form::number('cities', ayoubgr::frontend('cities') ,['class' => 'form-control','required','min'=>0]) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('vehicles',__('fleet.vehicles_serving'), ['class' => 'form-label']) !!}
              {!! Form::number('vehicles', ayoubgr::frontend('vehicles') ,['class' => 'form-control','required','min'=>0]) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('booking_time',__('fleet.booking_time'), ['class' => 'form-label']) !!}
              {!! Form::number('booking_time', ayoubgr::frontend('booking_time') ,['class' => 'form-control','required','min'=>1,'step'=>1]) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('cancellation',__('fleet.cancellation_link'), ['class' => 'form-label']) !!}
              {!! Form::text('cancellation', ayoubgr::frontend('cancellation') ,['class' => 'form-control']) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('terms',__('fleet.terms'), ['class' => 'form-label']) !!}
              {!! Form::text('terms', ayoubgr::frontend('terms') ,['class' => 'form-control']) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('privacy_policy',__('fleet.privacy_policy'), ['class' => 'form-label']) !!}
              {!! Form::text('privacy_policy', ayoubgr::frontend('privacy_policy') ,['class' => 'form-control']) !!}
            </div>
          </div>
        </div>
        <hr>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!! Form::text('facebook', ayoubgr::frontend('facebook') ,['class' => 'form-control']) !!}
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!! Form::text('twitter', ayoubgr::frontend('twitter') ,['class' => 'form-control']) !!}
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!! Form::text('instagram', ayoubgr::frontend('instagram') ,['class' => 'form-control']) !!}
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!! Form::text('linkedin', ayoubgr::frontend('linkedin') ,['class' => 'form-control']) !!}
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-3 col-sm-12">
              ...
              <label class="switch">
                <input type="checkbox" name="approval_required" value="1" id="approval_required" @if(ayoubgr::frontend('admin_approval')==1) checked @endif>
                <span class="slider round"></span>
              </label>
            </div>
          </div>
