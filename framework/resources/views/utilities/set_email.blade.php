            ...
            <div class="tab-content card-body">
              <div class="tab-pane active" id="insurance">
                ...
                <div class="form-group">
                  ...
                  <textarea name="insurance" id="ins">{{ayoubgr::email_msg('insurance')}}</textarea>
                </div>
              ...
              <div class="tab-pane" id="vehicle-licence">
                ...
                <div class="form-group">
                  ...
                  <textarea name="vehicle_licence" id="vl">{{ayoubgr::email_msg('vehicle_licence')}}</textarea>
                </div>
              ...
              <div class="tab-pane" id="driver-licence">
                ...
                <div class="form-group">
                  ...
                  <textarea name="driving_licence" id="dl">{{ayoubgr::email_msg('driving_licence')}}</textarea>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="submit" class="form-control btn btn-success" value="@lang('fleet.set')" />
              ...
              <div class="tab-pane" id="registration">
                ...
                <div class="form-group">
                  ...
                  <textarea name="registration" id="reg">{{ayoubgr::email_msg('registration')}}</textarea>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="submit" class="form-control btn btn-success" value="@lang('fleet.set')" />
              ...
              <div class="tab-pane" id="reminder">
                ...
                <div class="form-group">
                  ...
                  <textarea name="service_reminder" id="sr">{{ayoubgr::email_msg('service_reminder')}}</textarea>
                </div>
                {!! Form::hidden('sr','1') !!}
