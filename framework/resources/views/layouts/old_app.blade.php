...
<body class="hold-transition sidebar-mini" @if($language=="Arabic-ar" ) dir="rtl" @endif>
  ...
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <!--array of selected modules of logged in user-->
            @else
            @php($modules=array())
            @endif
            ...
            @if((Request::is('admin/bookings*')) || (Request::is('admin/bookings_calendar')) ||
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{ route('reports.work_order') }}"
                    class="nav-link @if(Request::is('admin/reports/work_order')) active @endif">
                    <i class="nav-icon fa fa-book"></i>
            ...
            @if(in_array(12,$modules) && ayoubgr::api('api_key') != null) <li class="nav-item">
            ...
            @if(ayoubgr::api('api') && ayoubgr::api('driver_review') == 1 && in_array(10,$modules)) <li class="nav-item">
    ...
    <footer class="main-footer">
      <strong>@lang('fleet.copyright') &copy; 2017-{{date("Y")}} <a href="https://ayoubgr.com">ayoubgr
          Solutions</a>.</strong>
      @lang('fleet.all_rights_reserved')
      <div class="float-right d-none d-sm-inline-block">
        <b>@lang('fleet.version')</b> 5.0.1
      </div>
    </footer>
