  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ url('admin/')}}" class="brand-link">
        <img src="{{ asset('assets/images/'. ayoubgr::get('icon_img') ) }}" alt="Fleet Logo" class="brand-image"
          style="opacity: .8">
        <span class="brand-text font-weight-light">{{ ayoubgr::get('app_name') }}</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="form-inline">
         ...
         with font-awesome or any other icon font library -->
              ...
              @if (!empty(ayoubgr::chat('pusher_app_id')) && !empty(ayoubgr::chat ('pusher_app_key')) &&
              ...
              @if(ayoubgr::get('fuel_enable_driver') == 1)
              ...
              @if(ayoubgr::get('income_enable_driver') == 1 || ayoubgr::get('expense_enable_driver') == 1)
              ...
              <li class="nav-item has-treeview {{$class}}">
                ...
                <ul class="nav nav-treeview">
                  @if(ayoubgr::get('income_enable_driver') == 1)
                  <li class="nav-item">
                  ...
                  @endif
                  @if(ayoubgr::get('expense_enable_driver') == 1)
                  <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('vehicles.index')}}"
                      class="nav-link @if(Request::is('admin/vehicles*')) active @endif">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('vehicle-make.index')}}"
                      class="nav-link @if(Request::is('admin/vehicle-make*')) active @endif">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('vehicle-color.index')}}"
                      class="nav-link @if(Request::is('admin/vehicle-color*')) active @endif">
                      <i class="fa fa-car nav-icon"></i>
              ...
              @if((Request::is('admin/transactions*')) || (Request::is('admin/bookings*')) ||
              ...
              @if(ayoubgr::api('api_key') != null && ayoubgr::api('db_url') != null) <li class="nav-item">
              ...
              @if(ayoubgr::api('api') && ayoubgr::api('driver_review') == 1) <li class="nav-item">
    ...
    <div class="content-wrapper">
      ...
      <audio id="chat-alert-sound" style="display: none">
        <source src="{{ asset('assets/chats/sound.mp3') }}" />
      </audio>
      <!-- /.content -->
    </div>
    <!-- /.content-wrapper -->
    <footer class="main-footer">
      {!! ayoubgr::get('web_footer') !!}
      <div class="float-right d-none d-sm-inline-block">
        <b>@lang('fleet.version')</b> 6.1
      </div>
    </footer>
