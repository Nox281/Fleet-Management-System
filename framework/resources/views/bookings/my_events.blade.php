...
<table class="table table-striped">
	<th>@lang('fleet.booking_id') : {{$booking->id}}</th>
	<tr>
	...
	<td>{{date(ayoubgr::get('date_format').' g:i A',strtotime($booking->pickup))}}</td>
	</tr>

	<tr>
	<th>@lang('fleet.dropoff')</th>
	<td>{{date(ayoubgr::get('date_format').' g:i A',strtotime($booking->dropoff))}}</td>
	</tr>
