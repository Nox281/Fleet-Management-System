...
<div class="invoice p-3 mb-3">
  <div class="row">
    <div class="col-12">
      <h4>
        ...
        <small class="float-right"> <b>@lang('fleet.date') : </b>{{
          date($date_format_setting,strtotime($i->booking_income->date)) }}</small>
      </h4>
    </div>
  </div>
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tr>
            ...
            <td>
              {{$booking->vehicle->maker['make']}} - {{$booking->vehicle->vehiclemodel['model']}} -
          ...
          <tr>
            ...
            <td>{{ ayoubgr::get('currency') }} {{ ($booking->total_tax_charge_rs) ? $booking->total_tax_charge_rs : 0 }}
            </td>
          </tr>
          <tr>
  ...
  <div class="row no-print">
    <div class="col-xs-12">
      <a href="{{url('admin/print/'.$id)}}" target="_blank" class="btn btn-danger"><i class="fa fa-print"></i>
        @lang('fleet.print')</a>
    </div>
  </div>
</div>
