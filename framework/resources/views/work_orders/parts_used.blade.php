      ...
      <div class="card-body table-responsive">
        <table class="table" id="data_table">
          ...
          <tbody>
            ...
            <tr>
              <td>{{ $row->workorder->vehicle->maker->make }} - {{ $row->workorder->vehicle->vehiclemodel->model }} - {{
                $row->workorder->vehicle->license_plate }}</td>
              <td>{!! $row->workorder->description !!}</td>
              <td>{{ $row->part->title }}</td>
              <td>{{ $row->qty }}</td>
              <td>{{ayoubgr::get('currency')." ". $row->price }}</td>
              <td>{{ ayoubgr::get('currency')." ". $row->total }}</td>
            </tr>
            @endforeach
          </tbody>
        </table>
