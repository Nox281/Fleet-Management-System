      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select id="vehicle_id" name="vehicle_id" class="form-control" required>
                ...
                <option value="{{$vehicle->id}}" @if($vehicle->id == $data->vehicle_id) selected @endif>
                  {{$vehicle->maker->make}} - {{$vehicle->vehiclemodel->model}} - {{$vehicle->license_plate}}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="form-group">
              {!! Form::label('meter',ayoubgr::get('dis_format')." ".__('fleet.reading'), ['class' => 'form-label']) !!}
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">{{ayoubgr::get('dis_format')}}</span>
                </div>
            ...
            <div class="form-group">
              ...
              {!! Form::select('status',["Pending"=>"Pending", "Processing"=>"Processing",
              "Completed"=>"Completed","Hold"=>"Hold"],$data->status,['class' => 'form-control','required']) !!}
            </div>
          </div>
          ...
          <div class="row col-md-12">
            ...
            <div class="col-md-2">
              <div class="form-group" style="margin-top: 30px"><a class="btn btn-danger"
                  href="{{ url('admin/remove-part/'.$row->id) }}">Remove</a> </div>
            </div>
          </div>
          @endforeach
