          ...
          <tbody>
            ...
            <tr>
              <td>
                ...
                @else
                  <img src="{{asset('uploads/'.$data->getMeta('driver_image'))}}" height="70px" width="70px">
                @endif
              </td>
              <td>
                {{$data->getMeta('first_name')}} {{$data->getMeta('last_name')}}
              </td>
              <td> @lang('fleet.driver_licence') {{ date(ayoubgr::get('date_format'),strtotime($notification->data['msg'])) }}</td>
              <td>
