    ...
    <div class="row">
      <div class="col-md-12">
        <table class="table" id="data_table">
          ...
          <tr>
            <td><b>@lang('fleet.kms_out') ({{ayoubgr::get('dis_format')}}): </b>
            {{$review->kms_outgoing}} {{ayoubgr::get('dis_format')}}</td>
          </tr>
          <tr>
            <td><b>@lang('fleet.kms_in') ({{ayoubgr::get('dis_format')}}): </b>
            {{$review->kms_incoming}} {{ayoubgr::get('dis_format')}}</td>
          </tr>
          <tr>
