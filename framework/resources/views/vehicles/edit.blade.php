            ...
            <div class="row card-body">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-xs-6">
                    <select name="make_id" class="form-control" required id="make_id">
                      ...
                      <option value="{{$make->id}}" @if($make->id == $vehicle->make_id) selected @endif>{{$make->make}}
                      </option>
                      @endforeach
                    </select>
                  </div>
                ...
                <div class="form-group">
                  ...
                  @if(ayoubgr::get('fuel_unit') == "gallon") {!! Form::label('average',
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-6">
                    <select name="color_id" class="form-control" required id="color_id">
                      ...
                      <option value="{{$color->id}}" @if($color->id == $vehicle->color_id)selected
