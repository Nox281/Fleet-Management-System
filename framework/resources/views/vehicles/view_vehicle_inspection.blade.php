...
@endsection
@section("breadcrumb")
<li class="breadcrumb-item"><a href="{{ url('admin/vehicle-inspection')}}">@lang('fleet.vehicle_inspection')</a></li>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              {{$review->kms_outgoing}} {{ayoubgr::get('dis_format')}}
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label('kms_in',__('fleet.kms_in')." (".ayoubgr::get('dis_format').") : ", ['class' => 'form-label']) !!}
              {{$review->kms_incoming}} {{ayoubgr::get('dis_format')}}
            </div>
          </div>
        </div>
        <div class="row">
