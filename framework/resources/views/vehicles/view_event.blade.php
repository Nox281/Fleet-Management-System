		...
		<div class="tab-pane active" id="info-tab">
			<table class="table table-striped">
				...
				<tr>
					...
					@if(ayoubgr::get('dis_format') == "km" && ayoubgr::get('fuel_unit') == "gallon")
					(@lang('fleet.kmpg'))
					@endif
					@if(ayoubgr::get('dis_format') == "km" && ayoubgr::get('fuel_unit') == "liter")
					(@lang('fleet.kmpl'))
					@endif
					@if(ayoubgr::get('dis_format') == "miles" && ayoubgr::get('fuel_unit') == "gallon")
					(@lang('fleet.mpg'))
					@endif
					@if(ayoubgr::get('dis_format') == "miles" && ayoubgr::get('fuel_unit') == "liter")
					(@lang('fleet.mpl'))
					@endif
				    </th>
					<td>
				...
				<tr>
					<th>@lang('fleet.intMileage') @if(ayoubgr::get('dis_format') == "km")(@lang('fleet.km')) @endif @if(ayoubgr::get('dis_format') == "miles")(@lang('fleet.miles')) @endif</th>
					<td>
						{{$vehicle->int_mileage}}
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						{{date(ayoubgr::get('date_format'),strtotime($vehicle->lic_exp_date))}}
						@endif
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						{{date(ayoubgr::get('date_format'),strtotime($vehicle->reg_exp_date))}}
						@endif
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						@if($vehicle->getMeta('ins_exp_date'))
							{{date(ayoubgr::get('date_format'),strtotime($vehicle->getMeta('ins_exp_date')))}}
						@endif
					</td>
				</tr>
			</table>
							...
							<table class="table">
								...
								<tbody id="hvk">
									...
									<tr>
										...
										@endphp
										<td>{{$row['exp_name']}}</td>
										<td>{{ayoubgr::get('currency')." ". $row['exp_amount']}}</td>
									</tr>
									@endforeach
									<tr>
										<td><strong>@lang('fleet.total')</strong></td>
										<td><strong>{{ayoubgr::get('currency')." ". $i}}</strong></td>
										<td></td>
									</tr>
									@endif
								</tbody>
