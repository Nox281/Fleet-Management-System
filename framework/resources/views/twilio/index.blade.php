        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              {!! Form::text('sid', ayoubgr::twilio('sid') ,['class' => 'form-control','required']) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('token',__('fleet.token'), ['class' => 'form-label']) !!}
              {!! Form::text('token', ayoubgr::twilio('token') ,['class' => 'form-control','required']) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!! Form::text('from', ayoubgr::twilio('from') ,['class' => 'form-control','required']) !!}
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              {!! Form::textarea('customer_message', ayoubgr::twilio('customer_message') ,['class' => 'form-control','required','size'=>'30x3']) !!}
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              {!! Form::textarea('driver_message', ayoubgr::twilio('driver_message') ,['class' => 'form-control','required','size'=>'30x3']) !!}
            </div>
          </div>
        </div>
