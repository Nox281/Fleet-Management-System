  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-10">
            <p class="text-center"><strong>Transactions: @if (count($dk) > 0){{$dk[0]}} - {{end($dk)}} @endif
              </strong></p>
            <div class="chart">
          ...
          <div class="col-md-2">
            ...
            <div class="info-box mb-3 bg-success">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">{{ ayoubgr::get("currency")}}{{$income}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <div class="info-box mb-3 bg-danger">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">{{ ayoubgr::get("currency")}}{{$expense}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            @endcan
