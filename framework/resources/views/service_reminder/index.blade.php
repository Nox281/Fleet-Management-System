          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                @lang('fleet.or') {{$reminder->services->overdue_meter}} {{ayoubgr::get('dis_format')}}
                @endif
              </td>
              <td>
              ...
              <td>
                ...
                @else
                  @php($int = ayoubgr::get('time_interval')."day")
                @endif
              ...
              <td>
                @if($reminder->services->overdue_meter != null)
                  @if($reminder->last_meter == 0)
                    {{$reminder->vehicle->int_mileage + $reminder->services->overdue_meter}} {{ayoubgr::get('dis_format')}}
                  @else
                    {{$reminder->last_meter + $reminder->services->overdue_meter}} {{ayoubgr::get('dis_format')}}
                  @endif
                @endif
              </td>
              <td>
