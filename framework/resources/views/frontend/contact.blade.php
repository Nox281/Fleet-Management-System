                    ...
                    <div class="col-md-6">
                        <div class="contact-tile">
                            ...
                            <div class="contact-tile-details">
                                ...
                                <p>@lang('frontend.contact_us_at') <strong class="primary">{{ ayoubgr::frontend('customer_support') }}</strong> </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="contact-tile">
                            ...
                            <div class="contact-tile-details">
                                ...
                                <p>@lang('frontend.contact_us_at') <strong class="primary">{{ ayoubgr::frontend('contact_phone') }}</strong> </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 ">
                        <div class="contact-tile">
                            ...
                            <div class="contact-tile-details">
                                ...
                                <p>@lang('frontend.send_your_email') <strong class="primary">{{ ayoubgr::frontend('contact_email') }}</strong> </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <section class="contact-map-section mb-5">
            <div class="map w-100 h-100">
                ...
                <script>
                    ...
                    var address = '{{ ayoubgr::get('badd1') . ", " . ayoubgr::get('badd2') . ", " . ayoubgr::get('city') . ", " . ayoubgr::get('state') . ", " . ayoubgr::get('country') . "." }}';
                ...
                <script src="https://maps.googleapis.com/maps/api/js?key={{ ayoubgr::api('api_key') }}&callback=initMap" async defer></script>
                <!-- Google map ends -->
            </div>
            ...
            <div class="contact-address">
                <h4 class="karla">
                    ...
                    <span class="p pt-1 text-center"> &emsp;{{ ayoubgr::get('badd1') . ", " . ayoubgr::get('badd2') . ", " . ayoubgr::get('city') . ", " . ayoubgr::get('state') . ", " . ayoubgr::get('country') . "." }}
                    </span>
                </h4>
            </div>
            ...
            <div class="container mb-4">
                ...
                <div class="contact-social-icons">
                    <div class="social-icon--facebook">
                        <a href="{{ ayoubgr::frontend('facebook') }}"> <i class="fab fa-facebook-f"></i></a>
                    </div>
                    <div class="social-icon--twitter">
                        <a href="{{ ayoubgr::frontend('twitter') }}"> <i class="fab fa-twitter"></i></a>
                    </div>
                    <div class="social-icon--instagram">
                        <a href="{{ ayoubgr::frontend('instagram') }}"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </section>
