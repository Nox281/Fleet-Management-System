                ...
                @if($bookings->count() > 0)
                    ...
                    <div class="booking">
                        <span class="booking-date">
                            {{ date((ayoubgr::get('date_format')) ? ayoubgr::get('date_format') : 'd-m-Y', strtotime($booking->journey_date)) }}
                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-3">
                                <div class="pills-container">
                                    ...
                                    @if($booking->tax_total)<span class="pill dark"> <span class="rupees"> {{ ayoubgr::get('currency') }} </span>{{ $booking->tax_total }}</span>@endif
                                    @if($booking->total_kms)<span class="pill dark"> <img src="{{ asset('assets/frontend/icons/fleet-kilometer.png')}}" alt=""> {{ $booking->total_kms }} {{ ayoubgr::get('dis_format') }} </span>@endif
