<!DOCTYPE html>
<html lang=en  @if(ayoubgr::frontend('language') == "ar") dir="rtl" @endif>
<head>
	<meta charset=utf-8>
	@if(ayoubgr::api('api_key'))
	<meta name=mapApi content="{{ayoubgr::api('api_key')}}">
	@endif
	...
	<meta name="lang" content="{{ ayoubgr::frontend('language') }}" />
...
<body @if(ayoubgr::frontend('language') == "ar") dir="rtl" @endif>
	<noscript>
