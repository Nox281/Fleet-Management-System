    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <h3>@lang('fleet.yearlyReport')&nbsp;<small>{{$year_select}}</small></h3>
          @if($vehicle != null)<h4>{{$vehicle->maker['make']}}-{{$vehicle->vehiclemodel['model']}}-{{$vehicle['license_plate']}}</h4> @endif
        </div>
      </div>
      <div class="row">
        <div class="col-md-4">
          ...
          <table class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <td>{{ ayoubgr::get("currency")}}{{$tot}}</td>
              </tr>
            </thead>
            <tbody>
              @foreach($income_by_cat as $exp)
              <tr>
                ...
                <td>{{ ayoubgr::get("currency")}}{{$exp->amount}}</td>
              </tr>
              @endforeach
            </tbody>
          </table>
