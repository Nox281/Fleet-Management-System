...
<li class="breadcrumb-item active">@lang('fleet.income') @lang('fleet.report')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <button type="submit" formaction="{{url('admin/print-income')}}" class="btn btn-danger" style="margin-right: 10px"><i class="fa fa-print"></i> @lang('fleet.print')</button>
        </div>
        {!! Form::close() !!}
      </div>
    </div>
        ...
        <table class="table table-bordered table-striped table-hover"  id="myTable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ayoubgr::get('currency')}} {{$row->amount}}</td>
              <td>{{$row->mileage}}</td>
            </tr>
            @endforeach
          </tbody>
