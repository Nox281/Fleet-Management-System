...
<div class="invoice p-3 mb-3">
  <div class="row">
    <div class="col-12">
      <h4>
        <span class="logo-lg">
          <img src="{{ asset('assets/images/'. ayoubgr::get('icon_img') ) }}" class="navbar-brand"
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tr>
            ...
            <td>
              {{$data->vehicle->maker['make']}} - {{$data->vehicle->vehiclemodel['model']}} -
          ...
          <tr>
            ...
            <td>{{ $data->mileage }} {{ ayoubgr::get('dis_format') }}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>{{ ayoubgr::get('currency') }} {{ $data->total }}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>{{ ayoubgr::get('currency') }} {{ ($data->total_tax_charge_rs) ? $data->total_tax_charge_rs : 0 }} </td>
          </tr>
          <tr>
            <th>@lang('fleet.total'):</th>
            <td>{{ ayoubgr::get('currency') }} {{ ($data->tax_total) ? $data->tax_total : $data->total }}</td>
          </tr>
        </table>
      </div>
    </div>
  ...
  <div class="row no-print">
    <div class="col-xs-12">
      <a href="{{url('admin/print-quote/'.$data->id)}}" target="_blank" class="btn btn-danger"><i
          class="fa fa-print"></i> @lang('fleet.print')</a>
    </div>
  </div>
</div>
@endsection