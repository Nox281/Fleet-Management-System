...
<li class="breadcrumb-item active">@lang('fleet.edit_quote')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    <div class="card card-warning">
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => ['booking-quotation.update',$data->id],'method'=>'PATCH']) !!}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select id="vehicle_id" name="vehicle_id" class="form-control" required>
                ...
                <option @if($vehicle->id==$data->vehicle_id) selected @endif value="{{$vehicle->id}}"
                  data-driver="{{$vehicle->driver_id}}" data-vehicle-type="{{strtolower(str_replace('
                  ','',$vehicle->types->vehicletype))}}" data-base-mileage="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_base_km')}}"
                  data-base-fare="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_base_fare')}}"
                  data-base_km_1="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_base_km')}}"
                  data-base_fare_1="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_base_fare')}}"
                  data-wait_time_1="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_base_time')}}"
                  data-std_fare_1="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_std_fare')}}"

                  data-base_km_2="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_weekend_base_km')}}"
                  data-base_fare_2="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_weekend_base_fare')}}"
                  data-wait_time_2="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_weekend_wait_time')}}"
                  data-std_fare_2="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_weekend_std_fare')}}"

                  data-base_km_3="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_night_base_km')}}"
                  data-base_fare_3="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_night_base_fare')}}"
                  data-wait_time_3="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_night_wait_time')}}"
                  data-std_fare_3="{{ayoubgr::fare(strtolower(str_replace('
                  ','',$vehicle->types->vehicletype)).'_night_std_fare')}}">{{$vehicle->maker->make}} -
                  {{$vehicle->vehiclemodel->model}} - {{$vehicle->license_plate}}</option>
                @endforeach
              </select>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select id="driver_id" name="driver_id" class="form-control" required>
                ...
                <option value="{{$driver->id}}" @if($driver->id == $data->driver_id) selected @endif>{{$driver->name}}
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label class="form-label">@lang('fleet.trip_mileage') ({{ayoubgr::get('dis_format')}})</label>
              {!! Form::number('mileage',$data->mileage,['class'=>'form-control
              sum','min'=>1,'id'=>'mileage','required']) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label class="form-label">@lang('fleet.waitingtime')</label>
              {!! Form::number('waiting_time',$data->waiting_time,['class'=>'form-control
              sum','min'=>0,'id'=>'waiting_time','required']) !!}
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">{{ayoubgr::get('currency')}}</span>
                </div>
                {!!
                Form::number('total',$data->total,['class'=>'form-control','id'=>'total','required','min'=>0,'step'=>'0.01'])
                !!}
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!! Form::number('total_tax_percent',$data->total_tax_percent,['class'=>'form-control
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!! Form::number('total_tax_charge_rs',$data->total_tax_charge_rs,['class'=>'form-control
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                {!!
                Form::number('tax_total',$data->tax_total,['class'=>'form-control','id'=>'tax_total','readonly','min'=>0,'step'=>'0.01'])
                !!}
              </div>
            </div>
          </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{ayoubgr::api('api_key')}}&libraries=places&callback=initMap"
  async defer></script>
@endif
@endsection