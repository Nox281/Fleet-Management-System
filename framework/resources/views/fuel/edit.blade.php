        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select id="vehicle_id" disabled="" name="vehicle_id" class="form-control xxhvk" required>
                <option selected value="{{$vehicle_id}}">{{$data->vehicle_data->maker['make']}} -
                  {{$data->vehicle_data->vehiclemodel['model']}} - {{$data->vehicle_data['license_plate']}}</option>
              </select>
            </div>
            <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="card card-solid">
              ...
              <div class="card-body">
                <input type="radio" name="fuel_from" class="flat-red" value="Fuel Tank" @if($data->fuel_from == "Fuel
                Tank") checked @endif>
                {!! Form::label('fuel_from', __('fleet.fuel_tank'), ['class' => 'form-label']) !!}
                <br>
                <input type="radio" name="fuel_from" class="flat-red" value="N/D" @if($data->fuel_from == "N/D") checked
                @endif >
                {!! Form::label('fuel_from', __('fleet.nd'), ['class' => 'form-label']) !!}
                <br>
                <input type="radio" name="fuel_from" class="flat-red" value="Vendor" @if($data->fuel_from == "Vendor")
                checked @endif>
            ...
            <div class="card card-solid">
              ...
              <div class="card-body">
                <div class="form-group">
                  {!! Form::label('qty',__('fleet.qty').' ('.ayoubgr::get('fuel_unit').')', ['class' => 'form-label'])
                  !!}
